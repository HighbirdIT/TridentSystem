...
var JoinType_Full = 'full join';
var JoinTypes_arr = [JoinType_Inner, JoinType_Left, JoinType_Right, JoinType_Cross, JoinType_Full];
...
var WidthFactors_arr = [{ text: '自动', value: EWidthFactor.Scale },
{ text: '0.5倍', value: EWidthFactor.Half },
...
const ThreeDAppType_arr = [EThreeDAppType.全局图拍照,EThreeDAppType.构件安装拍照,EThreeDAppType.构件模型查看,EThreeDAppType.大连组网拍照,EThreeDAppType.大连并网拍照,EThreeDAppType.大连WCB安装];
