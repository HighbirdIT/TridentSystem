...
class C_SqlNode_Mathfun extends React.PureComponent {
    constructor(props) {
        ...
        C_SqlNode_Base(this);
        this.state = {
            mathValue: this.props.nodedata.mathValue
        }
    }

    mathChangedHandler(newmath) {
        var nodeData = this.props.nodedata;
        nodeData.mathValue = newmath;
        this.setState({
            mathValue: newmath
        });
    }
    cusHeaderFuc() {
        ...
        var nodeData = this.props.nodedata;
        return (<div style={this.outDivStyle} f-canmove={1}>
                    <DropDownControl options_arr={Math_arr} value={nodeData.mathValue} itemChanged={this.mathChangedHandler} style={this.ddcStyle} />
                </div> 
