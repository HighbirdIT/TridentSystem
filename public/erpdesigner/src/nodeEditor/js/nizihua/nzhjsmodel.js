...
class JSNode_Md5 extends JSNode_Base {
    constructor(initData, parentNode, createHelper, nodeJson) {
        ...
        this.fileidSocket.type = ValueType.Object;
        this.fileidSocket.label = '文件标识';

        this.textSocket.type = ValueType.String;
        this.textSocket.label = '文本'

        this.autoSocket.type = ValueType.Boolean;
        this.autoSocket.label='自动更新表md5'
