                        ...
                        switch (bluePrint.group) {
                            ...
                            case EJsBluePrintFunGroup.GridRowBtnHandler:
                                ...
                                if (ctlKernel != null) {
                                    ...
                                    var isGetXMLRowItem = ctlKernel.type == M_FormKernel_Type && bluePrint.name.indexOf(AttrNames.Function.GetXMLRowItem) != -1;
                                    var optionFun = ctlKernel.getAccessableKernels;
                                    if(isGetXMLRowItem){
                                        optionFun = ctlKernel.getAllRowControls;
                                    }
                                    inputElem = [<DropDownControl key='ctlddc' socket={socket} options_arr={optionFun} funparamobj={kernelType} value={nowCtlId} itemChanged={this.kernelChangedHandler} textAttrName='readableName' valueAttrName='id' />];
