...
var M_LabelKernelAttrsSetting = GenControlKernelAttrsSetting([new CAttributeGroup('基本设置', [genTextFiledAttribute(), new CAttribute('数据类型', AttrNames.ValueType, ValueType.String, ValueType.String, true, false, JsValueTypes), new CAttribute('小数精度', AttrNames.FloatNum, ValueType.Int, 2, true, false, null, null, false), new CAttribute('输出字数', AttrNames.OutputCharCount, ValueType.Boolean, false), new CAttribute('逗号隔开', 'dotsplit', ValueType.Boolean, false), new CAttribute('缩写阈值', 'abbrevlen', ValueType.Int, 0, true, false, null, null, false), genIsdisplayAttribute(), new CAttribute('默认可见', AttrNames.DefaultVisible, ValueType.Boolean, true)]), new CAttributeGroup('事件', [new CAttribute('OnMDown', AttrNames.Event.OnMouseDown, ValueType.Event)])]);
