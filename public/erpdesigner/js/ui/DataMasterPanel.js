            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            'div',
                            { className: '', style: { maxHeight: '100px' } },
...
var CusDBEEditor = function (_React$PureComponent4) {
    ...
    _createClass(CusDBEEditor, [{
        ...
        value: function render() {
            ...
            return React.createElement('div', { className: 'd-block position-relative bg-light', style: { minWidth: '2000px', minHeight: '2000px' } });
        }
    }]);
...
var CreateDSItemPanel = function (_React$PureComponent5) {
    _inherits(CreateDSItemPanel, _React$PureComponent5);

    function CreateDSItemPanel(props) {
        _classCallCheck(this, CreateDSItemPanel);

        var _this7 = _possibleConstructorReturn(this, (CreateDSItemPanel.__proto__ || Object.getPrototypeOf(CreateDSItemPanel)).call(this, props));

        _this7.state = {
            items_arr: _this7.props.project.dataMaster.customDBEntities_arr,
            selectedItem: null
        };
        autoBind(_this7);
        return _this7;
        ...
        value: function render() {
            ...
            return React.createElement(SplitPanel, {
                ...
                panel1: React.createElement(
                    ...
                    React.createElement(
                        ...
                        this.state.items_arr.map(function (item) {
                            return React.createElement(
                                'div',
                                { onClick: _this8.clickListItemHandler, key: item.code, 'data-itemvalue': item.code, className: 'list-group-item list-group-item-action' + (selectedItem == item ? ' active' : '') },
                                item.name
                            );
                        })
                    )
                ...
                panel2: React.createElement(
                    'div',
                    { className: 'd-flex flex-grow-1 flex-shrink-1 bg-dark autoScroll mw-100' },
...
var DataMasterPanel = function (_React$PureComponent6) {
    _inherits(DataMasterPanel, _React$PureComponent6);

    function DataMasterPanel(props) {
        _classCallCheck(this, DataMasterPanel);

        var _this9 = _possibleConstructorReturn(this, (DataMasterPanel.__proto__ || Object.getPrototypeOf(DataMasterPanel)).call(this, props));

        _this9.panelBaseRef = React.createRef();
        _this9.state = {};

        autoBind(_this9);

        var navItems = [CreateNavItemData('数据库', React.createElement(DataBasePanel, { project: _this9.props.project })), CreateNavItemData('创建数据', React.createElement(CreateDSItemPanel, { project: _this9.props.project }))];
        _this9.navData = {
        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                this.navData.items.map(function (item) {
                    return React.createElement(
                        'div',
                        { key: item.text, className: 'flex-grow-1 flex-shrink-1 ' + (item == _this10.navData.selectedItem ? ' d-flex' : ' d-none') },
                        item.content
                    );
                })
            );
