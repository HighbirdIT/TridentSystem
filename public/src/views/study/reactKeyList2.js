        ...
        return (
            <div className="d-flex flex-column" style={{ width: this.props.width, height: this.props.height }}>
                ...
                <div className='d-flex flex-grow-1 flex-shrink-1 mt-1'>
                    <div className='flex-grow-1 flex-shrink-1 d-flex' ref={this.dropDowmDivRef}>
                        <button type='button' className='btn flex-grow-1 flex-shrink-1' data-toggle="dropdown" >{this.state.selectedText}</button>
                        <button type='button' className='btn flex-grow-0 flex-shrink-0 dropdown-toggle dropdown-toggle-split' data-toggle="dropdown" ></button>
