        ...
        switch (fileUploader.state) {
            case EFileUploaderState.WAITFILE:
                ...
                if (this.state.loading) {
                    ...
                    contentElem = <div className='w-100 h-100 cursor_hand' onClick={this.clickPlusHandler}>
                        <span className='centerelem position-absolute text-nowrap'>
                            <i className='fa fa-plus' />上传文件
                        </span>
                    </div>;
                }
                break;
    ...
    render() {
        ...
        return <div className={rootClassName} style={this.props.style}>
            ...
            <div className='bg-dark d-flex flex-shrink-0 flex-grow-0 p-1 align-items-center'>
                ...
                <button className='btn btn-success' onClick={this.plusClickHandler}><i className='fa fa-plus' />添加附件</button>
            </div>
            {invalidInfoElem}
            <div className={'list-group flex-grow-1 flex-shrink-1 border' + (bContentNeedScroll ? ' autoScroll' : '')}>
                ...
                <div className='list-group-item p-1'>
                    ...
                    <button className='btn btn-success m-1 btn-sm' onClick={this.plusClickHandler}><i className='fa fa-plus' />添加附件</button>
                </div>
            </div>
        </div>
    }
