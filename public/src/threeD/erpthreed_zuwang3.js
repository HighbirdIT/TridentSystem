...
class CM_Page_ZWParamShoter extends React.PureComponent {
    ...
    renderContent() {
        ...
        retElem = (
            <div className='d-flex flex-grow-1 flex-shrink-1 flex-column fixPageContent '>
                <VisibleERPC_IFrame className='flex-grow-1 flex-shrink-1 d-flex flex-column ' proj='ZWGJY' flowCode={this.props.flowCode} pageType='mb' onMessageFun={iframe_shot_onReceiveMsg} id='iframe_shot' parentPath={this.props.parentPath} />
                {this.renderSidePage()}
            </div>);
        return retElem;
    }
