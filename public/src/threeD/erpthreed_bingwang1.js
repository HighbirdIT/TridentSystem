...
class ERPC_ThreeDApp_BingWang extends React.PureComponent {
    constructor(props) {
        super();
        autoBind(this);
        ERPControlBase(this);
...
function popBingWangSelector(completeCallBack) {
    ...
    init_M_Page_ComSel();
    popPersistentPage('M_Page_BingWangSel', ()=>{return <VisibleCM_Page_BingWangSel key='M_Page_BingWangSel' />});
}
...
function init_M_Page_BingWangSel(state, parentPageID) {
    ...
    setTimeout(() => { M_Page_BingWangSel_onLoad(); }, 50);
...
class CM_Page_BingWangSel extends React.PureComponent {
    constructor(props) {
        super(props);
        this.id = 'M_Page_BingWangSel';
        ERPC_Page(this);
    }
    render() {
        var retElem = null;
    ...
    renderContent() {
        ...
        retElem = (
            <div className='d-flex flex-grow-1 flex-shrink-1 flex-column fixPageContent '>
                <VisibleERPC_IFrame className='flex-grow-1 flex-shrink-1 d-flex flex-column ' proj='mdgjy' flowCode='295' pageType='auto' onMessageFun={M_iframe_BingWangSel_onReceiveMsg} id='M_iframe_BingWangSel' parentPath='M_Page_BingWangSel' />
                {this.renderSidePage()}
            </div>);
        return retElem;
    }
...
const VisibleCM_Page_BingWangSel = ReactRedux.connect(CM_Page_BingWangSel_mapstatetoprops, CM_Page_BingWangSel_disptchtoprops)(CM_Page_BingWangSel);
