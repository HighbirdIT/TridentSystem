...
function InitDingDing(callBack, mobileAppendApi_arr, pcAppendApi_arr) {
    ...
    if (isMobile) {
        ...
        var jsapiArr = ['runtime.info', 'device.notification.prompt', 'device.notification.confirm', 'device.notification.alert', 'device.notification.toast', 'biz.navigation.close', 'biz.ding.post', 'biz.navigation.setRight', 'biz.navigation.setTitle', 'device.audio.startRecord', 'device.audio.stopRecord'];
