    ...
    _createClass(ERPC_MultiFileUploader, [{
        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                React.createElement('input', { onChange: this.fileSelectedHandler, ref: this.fileTagRef, type: 'file', className: 'd-none', multiple: 'multiple', accept: accept }),
                React.createElement(
                    'div',
...
var ERPC_FilePreview = function (_React$PureComponent5) {
    ...
    function ERPC_FilePreview(props) {
        ...
        _this12.rootDivRef = React.createRef();
        return _this12;
    }
    ...
    _createClass(ERPC_FilePreview, [{
        ...
        value: function render() {
            ...
            if (this.props.filePath == null || this.props.filePath.length == 0) {
                ...
                if (aidData.fileType == 'image') {
                    contetnElem = React.createElement('img', { onLoad: this.imgLoaded, className: 'w-100 h-100', src: window.location.origin + this.props.filePath, onClick: this.clickIconHandler });
                ...
                if (!this.canPreview) {
                    downloadBtn = React.createElement(
                        'button',
                        { onClick: this.clickIconHandler, type: 'button', className: 'btn btn-sm btn-primary' },
            ...
            var canDelte = this.props.canDelte;
            if (fileName.length > 15) {
            ...
            return React.createElement(
                'div',
                { className: divClassName, fixedsize: this.props.fixedsize, style: useSyle, ref: this.rootDivRef },
                contetnElem,
                ...
                React.createElement(
                    'div',
                    { id: 'toolbar', className: 'btn-group position-absolute', style: { right: '2px', bottom: '2px' } },
                    downloadBtn,
                    !canDelte ? null : React.createElement(
                        'button',
