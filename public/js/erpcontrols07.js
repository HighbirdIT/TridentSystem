...
function AppInit(app) {
    DeubgApp('app init' + (gParentFrame ? ' with parentFrame' : ''));
    if (gParentFrame) {
    ...
    _createClass(ERPC_IFrame, [{
        ...
        value: function trySendMsg(needDelay) {
            ...
            if (this.frameRef.current != null) {
                ...
                if (frameContentWindow.DistpathMsgFromParent) {
