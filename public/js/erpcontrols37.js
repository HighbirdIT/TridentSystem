...
var ERPC_DropDown = function (_React$PureComponent4) {
    ...
    _createClass(ERPC_DropDown, [{
        ...
        value: function getPopItemStyle() {
            ...
            var reg = /\d+\.?\d+/;
            while (temElem) {
                if (temElem.style.transform) {
                    var theTransFrom = temElem.style.transform;
            ...
            var rlt = {
                width: useWidth + 'px',
                left: (rootRect.left + useWidth < windowWidth ? rootRect.left : windowWidth - useWidth - 10) - translateX + 'px'
            };
            if (bottomSpace > topSpace) {
                rlt.top = rootRect.top + rootRect.height - translateY + 'px';
                rlt.maxHeight = bottomSpace - 20 + 'px';
            } else {
                rlt.bottom = windowHeight - rootRect.top - translateY + 'px';
