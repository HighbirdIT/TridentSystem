...
var selectDefaultValue = '=select-default=';
...
function BaseInfoView_mapStateToProps(state, ownprops) {
    ...
    usedFields_arr.forEach(function (field) {
        if (field.isrequired) {
            ...
            var errInfo = null;
            var iserr = nowValue == null || typeof nowValue == 'string' && nowValue == '' || field.attr.type == 'select' && nowValue == selectDefaultValue;
            if (!iserr) {
