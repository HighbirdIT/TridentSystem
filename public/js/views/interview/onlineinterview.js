...
// actions
var COUNTER_VALUE_CHANGED = 'COUNTER_VALUE_CHANGED';
var counterValueChanged = makeActionCreator(COUNTER_VALUE_CHANGED, 'name', 'value', 'counterID');
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        getUsedFields(this.props).map(function (field, i) {
                            return React.createElement(
                                List.Item,
                                { key: field.attr.name, nested: 'input' },
                                React.createElement(
                                    Container,
                                    { style: { flex: '1 1 auto' } },
                                    React.createElement(
        ...
        if (field.isrequired) {
            ...
            if (!iserr) {
                if (field.attr.name == 'name') {
                    ...
                    errInfo = nowValue < 3500 || nowValue > 100000 ? '数据有误' : null;
