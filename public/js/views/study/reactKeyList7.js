                ...
                if (selectedLeaf) {
                    ...
                    setTimeout(function () {
                        ...
                        if (leafDiv) {
                            ...
                            var targetScrollTop;
                            if (clientRect.top < 0) {
                                targetScrollTop = document.body.scrollTop + clientRect.top;
                                //console.log(document.body.scrollTop);
                            } else if (clientRect.bottom > document.body.clientHeight) {
                                targetScrollTop = document.body.scrollTop + clientRect.bottom - document.body.clientHeight;
                                //console.log(document.body.scrollTop);
                            }
                            ...
                            if (targetScrollTop != null) {
                                ...
                                self.scrolltopInt = setInterval(function () {
                                    var dis = targetScrollTop - document.body.scrollTop;
...
var MyApp = function (_React$PureComponent2) {
    ...
    _createClass(MyApp, [{
        ...
        value: function render() {
            ...
            return React.createElement(TreeControl, { multiselect: false });
