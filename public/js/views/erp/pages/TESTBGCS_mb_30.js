...
var M_Form_0headstyle0 = { "width": "16.7%", "maxWidth": "16.7%", "whiteSpace": "nowrap", "overflow": "hidden" };
var M_Form_0tdstyle0 = { "width": "16.7%", "maxWidth": "16.7%" };
var M_Form_0headstyle1 = { "width": "8.3%", "maxWidth": "8.3%", "whiteSpace": "nowrap", "overflow": "hidden" };
var M_Form_0tdstyle1 = { "width": "8.3%", "maxWidth": "8.3%" };
var M_Form_0headstyle2 = { "width": "33.3%", "maxWidth": "33.3%", "whiteSpace": "nowrap", "overflow": "hidden" };
var M_Form_0tdstyle2 = { "width": "33.3%", "maxWidth": "33.3%" };
	...
	_createClass(CM_Page_0, [{
		...
		value: function renderContent() {
			...
			retElem = React.createElement(
				...
				React.createElement(VisibleCM_Form_0, { id: "M_Form_0", parentPath: "M_Page_0", title: "\u4EC0\u4E48\u8868\u683C\uFF1F", pagebreak: true, reBindAT: "ReBindM_Form_0Page" })
			);
			return retElem;
		}
	}]);
...
var CM_Form_0 = function (_React$PureComponent3) {
	...
	_createClass(CM_Form_0, [{
		...
		value: function renderContent() {
			...
			return React.createElement(
				"div",
				{ className: "flex-grow-0 d-flex flex-shrink-1 erp-form flex-column ", style: { height: '50%' } },
			...
			for (var rowIndex = startRowIndex; rowIndex <= endRowIndex; ++rowIndex) {
				trElems_arr.push(React.createElement(
					...
					React.createElement(
						...
						React.createElement(VisibleERPC_Label, { className: "erp-control ", rowIndex: rowIndex, id: "M_Label_0", parentPath: "M_Page_0.M_Form_0" })
					),
					React.createElement(
						"td",
						{ style: M_Form_0tdstyle1 },
						React.createElement(VisibleERPC_Label, { className: "erp-control ", rowIndex: rowIndex, id: "M_Label_1", parentPath: "M_Page_0.M_Form_0" })
					),
					React.createElement(
						"td",
						{ style: M_Form_0tdstyle2 },
						React.createElement(VisibleERPC_Label, { className: "erp-control ", rowIndex: rowIndex, id: "M_Label_2", parentPath: "M_Page_0.M_Form_0" })
					),
					React.createElement(
						"td",
						{ style: M_Form_0tdstyle2 },
						React.createElement(VisibleERPC_Label, { className: "erp-control ", rowIndex: rowIndex, id: "M_Label_3", parentPath: "M_Page_0.M_Form_0" })
					),
					React.createElement(
						"td",
						{ style: M_Form_0tdstyle1 },
						React.createElement(VisibleERPC_Label, { className: "erp-control ", rowIndex: rowIndex, id: "M_Label_4", parentPath: "M_Page_0.M_Form_0" })
					)
				));
			}
			return React.createElement(
