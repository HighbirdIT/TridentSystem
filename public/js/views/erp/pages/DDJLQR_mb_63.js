...
function bind_M_Form_0(retState, newIndex, oldIndex) {
	...
	needSetState['M_LC_17.visible'] = false;
...
function bind_M_Form_2(retState, newIndex, oldIndex) {
	...
	var nowRecord = null;
	var useIndex = newIndex;
	needSetState['M_LC_36.visible'] = false;
	if (records_arr == null || newIndex == -1 || records_arr.length == 0) {} else {
		nowRecord = records_arr[useIndex];
		...
		needSetState['M_Label_34.text'] = nowRecord['下单人员工ID'];
		needSetState['M_Text_2.value'] = nowRecord['审核认定金额'];
		needSetState['M_Text_1.value'] = nowRecord['审核确认说明'];
		needSetState['M_Text_6.value'] = nowRecord['审核认定金额'];
		needSetState['M_Text_5.value'] = nowRecord['审核确认说明'];
		needSetState['M_Text_4.value'] = nowRecord['申辩确认说明'];
		needSetState['M_Text_7.value'] = nowRecord['审核认定金额'];
		needSetState['M_Text_8.value'] = nowRecord['审核确认说明'];
		needSetState['M_Text_9.value'] = nowRecord['申辩确认说明'];
		needSetState['M_Text_3.value'] = nowRecord['最终确认说明'];
		needSetState['M_LC_37.visible'] = M_LC_37_isdisplay_get(retState, bundle);
		needSetState['M_Text_2.value'] = M_Text_2_defaultvalue_get(retState, bundle);
		needSetState['M_LC_31.visible'] = M_LC_31_isdisplay_get(retState, bundle);
		needSetState['button_2.visible'] = button_2_isdisplay_get(retState, bundle);
		needSetState['M_LC_41.visible'] = M_LC_41_isdisplay_get(retState, bundle);
		needSetState['M_LC_40.visible'] = M_LC_40_isdisplay_get(retState, bundle);
		needSetState['M_LC_39.visible'] = M_LC_39_isdisplay_get(retState, bundle);
		needSetState['button_3.visible'] = button_3_isdisplay_get(retState, bundle);
		needSetState['button_4.visible'] = button_4_isdisplay_get(retState, bundle);
		needSetState['M_LC_42.visible'] = M_LC_42_isdisplay_get(retState, bundle);
		needSetState['M_LC_43.visible'] = M_LC_43_isdisplay_get(retState, bundle);
		needSetState['M_LC_44.visible'] = M_LC_44_isdisplay_get(retState, bundle);
		needSetState['M_LC_38.visible'] = M_LC_38_isdisplay_get(retState, bundle);
		needSetState['button_5.visible'] = button_5_isdisplay_get(retState, bundle);
		needSetState['button_6.visible'] = button_6_isdisplay_get(retState, bundle);
	}
	needSetState['nowRecord'] = nowRecord;
	needSetState['invalidbundle'] = false;
...
function M_LC_37_isdisplay_get(state, bundle) {
	...
	return M_Form_2_nowRecord['审核确认状态'] == 0;
}
function M_Text_2_validchecker(nowValue, comeState, comeValidErrState) {
	...
	if (nowValue > M_Form_2_nowRecord['订单总金额']) {
		var ret = callback_final(state, null, { info: '认定金额不能大于订单总金额' });
		return ret == null ? state : ret;
	}
}
function M_Text_2_defaultvalue_get(state, bundle) {
	...
	if (M_Form_2_nowRecord['审核认定金额'] != 0) {
		return M_Form_2_nowRecord['审核认定金额'];
	} else {
		return M_Form_2_nowRecord['订单总金额'];
	}
}
function M_LC_31_isdisplay_get(state, bundle) {
	var M_Form_2_nowRecord = bundle != null && bundle.M_Form_2_nowRecord != null ? bundle.M_Form_2_nowRecord : getStateByPath(state, 'M_Page_1.M_Form_2.nowRecord');
	var validErr;
	var hadValidErr = false;
	var validErrState = {};
...
function button_2_onclick() {
	...
	var M_Text_2_state = getStateByPath(M_Form_2_state, 'M_Text_2', {});
	var M_LC_37_state = getStateByPath(M_Form_2_state, 'M_LC_37', {});
	...
	var M_Text_4_state = getStateByPath(M_Form_2_state, 'M_Text_4', {});
	var M_LC_39_state = getStateByPath(M_Form_2_state, 'M_LC_39', {});
	var M_Text_4_value = M_Text_4_state.value;
	var M_Text_3_state = getStateByPath(M_Form_2_state, 'M_Text_3', {});
	var M_LC_38_state = getStateByPath(M_Form_2_state, 'M_LC_38', {});
	...
	var callback_final = function callback_final(state, data, err) {
		...
		if (err) {
			if (scriptBP_2_msg) {
				scriptBP_2_msg.setData(err.info, EMessageBoxType.Error, '审核确认');
			} else {
				SendToast(err.info, EToastType.Error);
			}
			return;
	...
	validErr = BaseIsValueValid(state, M_LC_37_state, M_Text_2_state, M_Text_2_value, 'float', false, 'M_Text_2', validErrState);
	validErrState['M_Page_1.M_Form_2.M_Text_2.invalidInfo'] = validErr;
	if (validErr != null) hadValidErr = true;
	...
	if (validErr != null) hadValidErr = true;
	validErr = BaseIsValueValid(state, M_LC_39_state, M_Text_4_state, M_Text_4_value, 'string', false, 'M_Text_4', validErrState);
	validErrState['M_Page_1.M_Form_2.M_Text_4.invalidInfo'] = validErr;
	if (validErr != null) hadValidErr = true;
	validErr = BaseIsValueValid(state, M_LC_38_state, M_Text_3_state, M_Text_3_value, 'string', false, 'M_Text_3', validErrState);
	validErrState['M_Page_1.M_Form_2.M_Text_3.invalidInfo'] = validErr;
	if (validErr != null) hadValidErr = true;
	if (hadValidErr) {
		return callback_final(null, null, { info: gPreconditionInvalidInfo });
	}
	...
	scriptBP_2_msg = PopMessageBox('', EMessageBoxType.Loading, '审核确认');;
	if (M_Form_2_nowRecord['订单总金额'] == M_Text_2_value) {
		var bundle_update_table_0 = {
			...
			M_Form_2_下单人员工ID: M_Form_2_nowRecord['下单人员工ID']
		};
		setTimeout(function () {
		...
		if (M_Text_1_value == '无') {
			var ret = callback_final(state, null, { info: '订单总金额和认定金额不一致，请给出说明。' });
			return ret == null ? state : ret;
		} else {
			var bundle_update_table_1 = {
				...
				审核确认状态: 2,
				M_Text_1_value: M_Text_1_value,
				申辩确认用户: M_Form_2_nowRecord['下单人员工ID'],
				M_Text_4_value: M_Text_4_value,
				M_Text_3_value: M_Text_3_value,
				M_Form_2_滴滴乘车记录代码: M_Form_2_nowRecord['滴滴乘车记录代码'],
				M_Form_2_下单人员工ID: M_Form_2_nowRecord['下单人员工ID']
...
function M_LC_41_isdisplay_get(state, bundle) {
	var M_Form_2_nowRecord = bundle != null && bundle.M_Form_2_nowRecord != null ? bundle.M_Form_2_nowRecord : getStateByPath(state, 'M_Page_1.M_Form_2.nowRecord');
	var validErr;
	var hadValidErr = false;
	var validErrState = {};
	...
	return M_Form_2_nowRecord['审核确认状态'] == 2 && M_Form_2_nowRecord['申辩确认状态'] == 0;
}
function M_LC_40_isdisplay_get(state, bundle) {
	var M_Form_2_nowRecord = bundle != null && bundle.M_Form_2_nowRecord != null ? bundle.M_Form_2_nowRecord : getStateByPath(state, 'M_Page_1.M_Form_2.nowRecord');
	var validErr;
	var hadValidErr = false;
	var validErrState = {};
...
function M_LC_39_isdisplay_get(state, bundle) {
	var M_Form_2_nowRecord = bundle != null && bundle.M_Form_2_nowRecord != null ? bundle.M_Form_2_nowRecord : getStateByPath(state, 'M_Page_1.M_Form_2.nowRecord');
	var validErr;
	var hadValidErr = false;
	var validErrState = {};
...
function button_3_isdisplay_get(state, bundle) {
	var M_Form_2_nowRecord = bundle != null && bundle.M_Form_2_nowRecord != null ? bundle.M_Form_2_nowRecord : getStateByPath(state, 'M_Page_1.M_Form_2.nowRecord');
	var validErr;
	var hadValidErr = false;
	var validErrState = {};
...
function button_3_onclick() {
	...
	var callback_final = function callback_final(state, data, err) {
		...
		if (err) {
			if (scriptBP_3_msg) {
				scriptBP_3_msg.setData(err.info, EMessageBoxType.Error, '申辩确认');
			} else {
				SendToast(err.info, EToastType.Error);
			}
			return;
	...
	scriptBP_3_msg = PopMessageBox('', EMessageBoxType.Loading, '申辩确认');;
	if (M_Text_4_value == '无') {
		var ret = callback_final(state, null, { info: '请给出申辩的理由。' });
		return ret == null ? state : ret;
	} else {
		var bundle_querysql_0 = {
			查询员工姓名代码: M_Form_2_nowRecord['下单人员工ID'],
			领导最低职级代码: 3,
			M_Form_2_滴滴乘车记录代码: M_Form_2_nowRecord['滴滴乘车记录代码'],
			M_Form_2_下单人员工ID: M_Form_2_nowRecord['下单人员工ID']
		};
...
function button_4_isdisplay_get(state, bundle) {
	var M_Form_2_nowRecord = bundle != null && bundle.M_Form_2_nowRecord != null ? bundle.M_Form_2_nowRecord : getStateByPath(state, 'M_Page_1.M_Form_2.nowRecord');
	var validErr;
	var hadValidErr = false;
	var validErrState = {};
...
function button_4_onclick() {
	var state = store.getState();
	var M_Form_2_state = getStateByPath(state, 'M_Page_1.M_Form_2', {});
	var M_Text_6_state = getStateByPath(M_Form_2_state, 'M_Text_6', {});
	var M_LC_41_state = getStateByPath(M_Form_2_state, 'M_LC_41', {});
	...
	var callback_final = function callback_final(state, data, err) {
		...
		if (err) {
			if (scriptBP_7_msg) {
				scriptBP_7_msg.setData(err.info, EMessageBoxType.Error, '不需申辩');
			} else {
				SendToast(err.info, EToastType.Error);
			}
			return;
	...
	validErr = BaseIsValueValid(state, M_LC_41_state, M_Text_6_state, M_Text_6_value, 'string', false, 'M_Text_6', validErrState);
	validErrState['M_Page_1.M_Form_2.M_Text_6.invalidInfo'] = validErr;
	if (validErr != null) hadValidErr = true;
	validErr = BaseIsValueValid(state, M_LC_37_state, M_Text_2_state, M_Text_2_value, 'float', false, 'M_Text_2', validErrState);
	validErrState['M_Page_1.M_Form_2.M_Text_2.invalidInfo'] = validErr;
	if (validErr != null) hadValidErr = true;
	...
	scriptBP_7_msg = PopMessageBox('', EMessageBoxType.Loading, '不需申辩');;
	var bundle_update_table_0 = {
		RCDKEY: M_Form_2_nowRecord['滴滴乘车记录代码'],
		M_Text_2_value: M_Text_2_value,
		M_Text_1_value: M_Text_1_value,
...
function M_LC_42_isdisplay_get(state, bundle) {
	var M_Form_2_nowRecord = bundle != null && bundle.M_Form_2_nowRecord != null ? bundle.M_Form_2_nowRecord : getStateByPath(state, 'M_Page_1.M_Form_2.nowRecord');
	var validErr;
	var hadValidErr = false;
	var validErrState = {};
	...
	return M_Form_2_nowRecord['审核确认状态'] == 2 && M_Form_2_nowRecord['申辩确认状态'] == 1 && M_Form_2_nowRecord['最终确认状态'] == 0;
}
function M_LC_43_isdisplay_get(state, bundle) {
	var M_Form_2_nowRecord = bundle != null && bundle.M_Form_2_nowRecord != null ? bundle.M_Form_2_nowRecord : getStateByPath(state, 'M_Page_1.M_Form_2.nowRecord');
	var validErr;
	var hadValidErr = false;
	var validErrState = {};
...
function M_LC_44_isdisplay_get(state, bundle) {
	var M_Form_2_nowRecord = bundle != null && bundle.M_Form_2_nowRecord != null ? bundle.M_Form_2_nowRecord : getStateByPath(state, 'M_Page_1.M_Form_2.nowRecord');
	var validErr;
	var hadValidErr = false;
	var validErrState = {};
...
function M_LC_38_isdisplay_get(state, bundle) {
	var M_Form_2_nowRecord = bundle != null && bundle.M_Form_2_nowRecord != null ? bundle.M_Form_2_nowRecord : getStateByPath(state, 'M_Page_1.M_Form_2.nowRecord');
	var validErr;
	var hadValidErr = false;
	var validErrState = {};
...
function button_5_isdisplay_get(state, bundle) {
	var M_Form_2_nowRecord = bundle != null && bundle.M_Form_2_nowRecord != null ? bundle.M_Form_2_nowRecord : getStateByPath(state, 'M_Page_1.M_Form_2.nowRecord');
	var validErr;
	var hadValidErr = false;
	var validErrState = {};
...
function button_5_onclick() {
	...
	var M_LC_38_state = getStateByPath(M_Form_2_state, 'M_LC_38', {});
	var M_Text_3_value = M_Text_3_state.value;
	var M_Label_19_state = getStateByPath(M_Form_2_state, 'M_Label_19', {});
	var M_LC_20_state = getStateByPath(M_Form_2_state, 'M_LC_20', {});
	var M_Label_19_text = M_Label_19_state.text;
	var M_Text_2_state = getStateByPath(M_Form_2_state, 'M_Text_2', {});
	var M_LC_37_state = getStateByPath(M_Form_2_state, 'M_LC_37', {});
	var M_Text_2_value = M_Text_2_state.value;
	var M_Text_1_state = getStateByPath(M_Form_2_state, 'M_Text_1', {});
	...
	var callback_final = function callback_final(state, data, err) {
		...
		if (err) {
			if (scriptBP_8_msg) {
				scriptBP_8_msg.setData(err.info, EMessageBoxType.Error, '认定申辩金额');
			} else {
				SendToast(err.info, EToastType.Error);
			}
			return;
	...
	scriptBP_8_msg = PopMessageBox('', EMessageBoxType.Loading, '认定申辩金额');;
	if (M_Text_3_value == '无') {
		var ret = callback_final(state, null, { info: '请给出认定理由。' });
		return ret == null ? state : ret;
	} else {
		var bundle_update_table_0 = {
			RCDKEY: M_Form_2_nowRecord['滴滴乘车记录代码'],
			...
			M_Text_3_value: M_Text_3_value,
			最终确认状态: 1,
			最终确认金额: M_Label_19_text,
			M_Form_2_最终确认说明: M_Form_2_nowRecord['最终确认说明'],
			M_Form_2_滴滴乘车记录代码: M_Form_2_nowRecord['滴滴乘车记录代码'],
			M_Form_2_订单总金额: M_Form_2_nowRecord['订单总金额']
		};
		setTimeout(function () {
			store.dispatch(fetchJsonPost(appServerUrl, { bundle: bundle_update_table_0, action: 'button_5_onclick_update_table_0' }, makeFTD_Callback(function (state, data_update_table_0, err_update_table_0) {
				if (err_update_table_0 == null) {
					setTimeout(function () {
						pull_M_Form_2();
					}, 50);
...
function button_6_isdisplay_get(state, bundle) {
	var M_Form_2_nowRecord = bundle != null && bundle.M_Form_2_nowRecord != null ? bundle.M_Form_2_nowRecord : getStateByPath(state, 'M_Page_1.M_Form_2.nowRecord');
	var validErr;
	var hadValidErr = false;
	var validErrState = {};
...
function button_6_onclick() {
	var state = store.getState();
	var M_Form_2_state = getStateByPath(state, 'M_Page_1.M_Form_2', {});
	var M_Text_7_state = getStateByPath(M_Form_2_state, 'M_Text_7', {});
	var M_LC_42_state = getStateByPath(M_Form_2_state, 'M_LC_42', {});
	...
	var callback_final = function callback_final(state, data, err) {
		...
		if (err) {
			if (scriptBP_9_msg) {
				scriptBP_9_msg.setData(err.info, EMessageBoxType.Error, '认定审核金额');
			} else {
				SendToast(err.info, EToastType.Error);
			}
			return;
	...
	validErr = BaseIsValueValid(state, M_LC_42_state, M_Text_7_state, M_Text_7_value, 'string', false, 'M_Text_7', validErrState);
	validErrState['M_Page_1.M_Form_2.M_Text_7.invalidInfo'] = validErr;
	if (validErr != null) hadValidErr = true;
	validErr = BaseIsValueValid(state, M_LC_37_state, M_Text_2_state, M_Text_2_value, 'float', false, 'M_Text_2', validErrState);
	validErrState['M_Page_1.M_Form_2.M_Text_2.invalidInfo'] = validErr;
	if (validErr != null) hadValidErr = true;
	...
	scriptBP_9_msg = PopMessageBox('', EMessageBoxType.Loading, '认定审核金额');;
	if (M_Form_2_nowRecord['最终确认说明'] == '无') {
		var ret = callback_final(state, null, { info: '请给出认定的理由。' });
		return ret == null ? state : ret;
	} else {
		var bundle_update_table_0 = {
			RCDKEY: M_Form_2_nowRecord['滴滴乘车记录代码'],
			...
			M_Text_3_value: M_Text_3_value,
			最终确认状态: 2,
			最终确认金额: M_Text_7_value,
			M_Form_2_滴滴乘车记录代码: M_Form_2_nowRecord['滴滴乘车记录代码'],
			M_Form_2_审核认定金额: M_Form_2_nowRecord['审核认定金额']
		};
		setTimeout(function () {
							...
							retElem = React.createElement(
								...
								React.createElement(
									...
									React.createElement(
										...
										React.createElement(
											VisibleERPC_Button,
											{ className: "flex-grow-1 btn btn-success erp-control ", id: "button_0", parentPath: "M_Page_0.M_Form_0", onClick: button_0_onclick },
											"\u5DE5\u4F5C\u7528\u8F66"
										),
										React.createElement(
											VisibleERPC_Button,
											{ className: "flex-grow-1 btn btn-danger erp-control ", id: "button_1", parentPath: "M_Page_0.M_Form_0", onClick: button_1_onclick },
											"\u79C1\u4EBA\u7528\u8F66"
										)
									),
						...
						if (!this.props.canInsert && this.props.nowRecord == null) {
							...
							retElem = React.createElement(
								...
								React.createElement(
									...
									React.createElement(
										VisibleERPC_LabeledControl,
										{ id: "M_LC_36", parentPath: "M_Page_1.M_Form_2", label: "\u4E0B\u5355\u4EBA\u5458\u5DE5ID", visible: false },
										React.createElement(VisibleERPC_Label, { className: "erp-control ", id: "M_Label_34", parentPath: "M_Page_1.M_Form_2", type: "string" })
									),
									React.createElement(
										VisibleERPC_LabeledControl,
										{ id: "M_LC_37", parentPath: "M_Page_1.M_Form_2", label: "\u5BA1\u6838\u8BA4\u5B9A\u91D1\u989D" },
										React.createElement(VisibleERPC_Text, { id: "M_Text_2", parentPath: "M_Page_1.M_Form_2", type: "float", precision: "2" })
									),
									React.createElement(
										VisibleERPC_LabeledControl,
									...
									React.createElement(
										...
										React.createElement(
											VisibleERPC_Button,
											{ className: "flex-grow-1 btn btn-success erp-control ", id: "button_2", parentPath: "M_Page_1.M_Form_2", onClick: button_2_onclick },
											"\u5BA1\u6838\u786E\u8BA4"
										)
									),
									React.createElement(
										VisibleERPC_LabeledControl,
										{ id: "M_LC_41", parentPath: "M_Page_1.M_Form_2", label: "\u5BA1\u6838\u8BA4\u5B9A\u91D1\u989D" },
										React.createElement(VisibleERPC_Text, { id: "M_Text_6", parentPath: "M_Page_1.M_Form_2", type: "string", linetype: "single", readonly: true })
									),
									React.createElement(
										VisibleERPC_LabeledControl,
										{ id: "M_LC_40", parentPath: "M_Page_1.M_Form_2", label: "\u5BA1\u6838\u786E\u8BA4\u8BF4\u660E" },
										React.createElement(VisibleERPC_Text, { id: "M_Text_5", parentPath: "M_Page_1.M_Form_2", type: "string", linetype: "1x", readonly: true })
									),
									React.createElement(
										VisibleERPC_LabeledControl,
										{ id: "M_LC_39", parentPath: "M_Page_1.M_Form_2", label: "\u7533\u8FA9\u786E\u8BA4\u8BF4\u660E" },
										React.createElement(VisibleERPC_Text, { id: "M_Text_4", parentPath: "M_Page_1.M_Form_2", type: "string", linetype: "1x" })
									),
									React.createElement(
										"div",
										{ className: "btn-group flex-grow-0 flex-shrink-0 d-flex erp-control " },
										React.createElement(
											VisibleERPC_Button,
											{ className: "flex-grow-1 btn btn-success erp-control ", id: "button_3", parentPath: "M_Page_1.M_Form_2", onClick: button_3_onclick },
											"\u7533\u8FA9\u786E\u8BA4"
										),
										React.createElement(
											VisibleERPC_Button,
											{ className: "flex-grow-1 btn btn-danger erp-control ", id: "button_4", parentPath: "M_Page_1.M_Form_2", onClick: button_4_onclick },
											"\u4E0D\u9700\u7533\u8FA9"
										)
									),
									React.createElement(
										VisibleERPC_LabeledControl,
										{ id: "M_LC_42", parentPath: "M_Page_1.M_Form_2", label: "\u5BA1\u6838\u8BA4\u5B9A\u91D1\u989D" },
										React.createElement(VisibleERPC_Text, { id: "M_Text_7", parentPath: "M_Page_1.M_Form_2", type: "string", linetype: "single", readonly: true })
									),
									React.createElement(
										VisibleERPC_LabeledControl,
										{ id: "M_LC_43", parentPath: "M_Page_1.M_Form_2", label: "\u5BA1\u6838\u786E\u8BA4\u8BF4\u660E" },
										React.createElement(VisibleERPC_Text, { id: "M_Text_8", parentPath: "M_Page_1.M_Form_2", type: "string", linetype: "1x", readonly: true })
									),
									React.createElement(
										VisibleERPC_LabeledControl,
										{ id: "M_LC_44", parentPath: "M_Page_1.M_Form_2", label: "\u7533\u8FA9\u786E\u8BA4\u8BF4\u660E" },
										React.createElement(VisibleERPC_Text, { id: "M_Text_9", parentPath: "M_Page_1.M_Form_2", type: "string", linetype: "1x", readonly: true })
									),
									React.createElement(
										VisibleERPC_LabeledControl,
										{ id: "M_LC_38", parentPath: "M_Page_1.M_Form_2", label: "\u6700\u7EC8\u786E\u8BA4\u8BF4\u660E" },
										React.createElement(VisibleERPC_Text, { id: "M_Text_3", parentPath: "M_Page_1.M_Form_2", type: "string", linetype: "1x" })
									),
									React.createElement(
										"div",
										...
										React.createElement(
											VisibleERPC_Button,
											{ className: "flex-grow-1 btn btn-success erp-control ", id: "button_5", parentPath: "M_Page_1.M_Form_2", onClick: button_5_onclick },
											"\u8BA4\u5B9A\u7533\u8FA9\u91D1\u989D"
										),
										React.createElement(
											VisibleERPC_Button,
											{ className: "flex-grow-1 btn btn-danger erp-control ", id: "button_6", parentPath: "M_Page_1.M_Form_2", onClick: button_6_onclick },
											"\u8BA4\u5B9A\u5BA1\u6838\u91D1\u989D"
										)
									),
