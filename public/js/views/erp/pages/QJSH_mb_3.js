...
function bind_M_Form_1(retState, newIndex, oldIndex) {
	...
	if (records_arr == null || newIndex == -1 || records_arr.length == 0) {} else {
		...
		needSetState['M_Text_2.value'] = nowRecord['请假起始时间'];
		needSetState['M_Label_6.text'] = nowRecord['请假结束日期'];
		needSetState['M_Text_5.value'] = nowRecord['请假结束时间'];
				...
				if (!this.props.canInsert && this.props.nowRecord == null) {
					...
					retElem = React.createElement(
						...
						React.createElement(
							...
							React.createElement(VisibleERPC_Label, { className: "erp-control ", id: "M_Label_3", parentPath: "M_Page_2.M_Form_1" })
						),
						React.createElement(
							VisibleERPC_LabeledControl,
							{ id: "M_LC_1", parentPath: "M_Page_2.M_Form_1", label: "\u5047\u671F\u79CD\u7C7B" },
							React.createElement(VisibleERPC_Label, { className: "erp-control ", id: "M_Label_4", parentPath: "M_Page_2.M_Form_1" })
						),
						React.createElement(
							VisibleERPC_LabeledControl,
						...
						React.createElement(
							...
							React.createElement(VisibleERPC_Label, { className: "erp-control ", id: "M_Label_5", parentPath: "M_Page_2.M_Form_1" })
						),
						React.createElement(
							VisibleERPC_LabeledControl,
							{ id: "M_LC_3", parentPath: "M_Page_2.M_Form_1", label: "\u8D77\u59CB\u65F6\u95F4" },
							React.createElement(VisibleERPC_Text, { id: "M_Text_2", parentPath: "M_Page_2.M_Form_1", type: "time", readonly: true })
						),
						React.createElement(
							VisibleERPC_LabeledControl,
							{ id: "M_LC_4", parentPath: "M_Page_2.M_Form_1", label: "\u7ED3\u675F\u65E5\u671F" },
							React.createElement(VisibleERPC_Label, { className: "erp-control ", id: "M_Label_6", parentPath: "M_Page_2.M_Form_1" })
						),
						React.createElement(
							VisibleERPC_LabeledControl,
							{ id: "M_LC_6", parentPath: "M_Page_2.M_Form_1", label: "\u7ED3\u675F\u65F6\u95F4" },
							React.createElement(VisibleERPC_Text, { id: "M_Text_5", parentPath: "M_Page_2.M_Form_1", type: "time", readonly: true })
						),
						React.createElement(
							VisibleERPC_LabeledControl,
							{ id: "M_LC_7", parentPath: "M_Page_2.M_Form_1", label: "\u4E8B\u7531\u8BF4\u660E" },
							React.createElement(VisibleERPC_Label, { className: "erp-control ", id: "M_Label_7", parentPath: "M_Page_2.M_Form_1" })
						),
						...
						React.createElement(
							"div",
							{ className: "btn-group flex-grow-0 d-flex flex-shrink-1 erp-control " },
							React.createElement(
								"button",
