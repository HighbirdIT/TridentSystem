...
var M_Form_0headstyle0 = { "width": "37.5%", "maxWidth": "37.5%", "whiteSpace": "nowrap", "overflow": "hidden" };
var M_Form_0tdstyle0 = { "width": "37.5%", "maxWidth": "37.5%" };
var M_Form_0headstyle1 = { "width": "25%", "maxWidth": "25%", "whiteSpace": "nowrap", "overflow": "hidden" };
var M_Form_0tdstyle1 = { "width": "25%", "maxWidth": "25%" };
...
function bind_M_Form_0(retState, newIndex, oldIndex) {
	var formState = getStateByPath(retState, 'M_Page_2.M_Form_0', {});
	...
	return setManyStateByPath(retState, 'M_Page_2.M_Form_0', needSetState);
}
function pull_M_Form_0(retState) {
	var bundle = {};
	var useState = retState == null ? store.getState() : retState;
	store.dispatch(fetchJsonPost(appServerUrl, { bundle: bundle, action: 'pulldata_M_Form_0' }, makeFTD_Prop('M_Page_2', 'M_Form_0', 'records_arr', false), EFetchKey.FetchPropValue));
	return retState;
}
	...
	_createClass(CM_Page_2, [{
		...
		value: function renderContent() {
			...
			retElem = React.createElement(
				...
				React.createElement(VisibleCM_Form_0, { id: "M_Form_0", parentPath: "M_Page_2", pagebreak: false, reBindAT: "ReBindM_Form_0Page" }),
...
function CM_Form_0_mapstatetoprops(state, ownprops) {
	var retProps = {};
	var ctlState = getStateByPath(state, 'M_Page_2.M_Form_0', {});
			...
			for (var rowIndex = startRowIndex; rowIndex <= endRowIndex; ++rowIndex) {
				trElems_arr.push(React.createElement(
					...
					React.createElement(
						...
						React.createElement(VisibleERPC_Text, { rowIndex: rowIndex, id: "M_Text_0", parentPath: "M_Page_2.M_Form_0", type: "string", linetype: "single" })
					),
					React.createElement(
						"td",
						{ style: M_Form_0tdstyle1 },
						React.createElement(VisibleERPC_Text, { rowIndex: rowIndex, id: "M_Text_7", parentPath: "M_Page_2.M_Form_0", type: "string", linetype: "single" })
					),
					React.createElement(
						"td",
						{ style: M_Form_0tdstyle0 },
						React.createElement(VisibleERPC_Text, { rowIndex: rowIndex, id: "M_Text_8", parentPath: "M_Page_2.M_Form_0", type: "string", linetype: "single" })
					)
				));
			}
			return React.createElement(
