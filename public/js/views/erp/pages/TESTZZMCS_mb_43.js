...
var M_Container_0_style = { "height": "200px" };
	...
	_createClass(CM_Page_0, [{
		...
		value: function renderContent() {
			...
			retElem = React.createElement(
				...
				React.createElement(
					"div",
					{ className: "bg-info flex-grow-0 d-flex flex-shrink-1 erp-control ", style: M_Container_0_style },
					React.createElement(
						"span",
						{ className: "erp-control " },
						"\u543C\u543C"
					),
					React.createElement("div", { className: "bg-danger d-flex flex-grow-1 flex-shrink-1 erp-control " }),
					React.createElement(
						"span",
						{ className: "erp-control " },
						"\u54C8\u54C8"
