...
var appStateChangedAct_map = { 'M_Page_0.M_Form_0.M_CheckBox_0.visible': M_CheckBox_0_visible_changed.bind(window) };
...
function M_LC_7_isdisplay_get(state, bundle) {
	...
	var M_CheckBox_0_visible = bundle != null && bundle['M_CheckBox_0_visible'] != null ? bundle['M_CheckBox_0_visible'] : M_CheckBox_0_state.visible;
	return M_CheckBox_0_visible == 1;
}
...
function M_CheckBox_0_visible_changed(state, newValue, oldValue, path, visited, delayActs) {
	var needSetState = {};
