...
function M_LC_3_textfield_get(state, bundle) {
	var M_Form_0_nowrecord = bundle.M_Form_0_nowrecord;
	return M_Form_0_nowrecord['员工登记姓名代码'] * 10;
}
