...
var appStateChangedAct_map = { 'M_Page_0.M_Form_0.records_arr': fresh_M_Form_0.bingd(window) };
		...
		value: function renderContent() {
			...
			retElem = React.createElement(
				...
				React.createElement(
					...
					React.createElement(VisibleERPC_Label, { className: 'erp-control ', id: 'M_Label_0', parentPath: 'M_Page_0.M_Form_0' }),
					React.createElement('div', { className: 'flex-grow-1 d-flex flex-shrink-1 erp-control ' })
				),
				React.createElement(
...
function CM_Form_0_mapstatetoprops(state, ownprops) {
	var retProps = {};
	var ctlState = getStateByPath(state, MakePath(ownprops.parentPath, this.id), {});
