...
var CM_Form_0 = function (_React$PureComponent3) {
	...
	_createClass(CM_Form_0, [{
		...
		value: function onUpdate(rowIndex, callBack) {
			...
			M_Text_1_state = getStateByPath(M_Form_0_rowState, 'M_Text_1', {});
			M_LC_1_state = getStateByPath(M_Form_0_rowState, 'M_LC_1', {});
			M_Text_1_value = M_Text_1_state.value;
			if (IsEmptyString(M_Form_0_nowRecord)) {
	...
	_createClass(CM_Form_1, [{
		...
		value: function submitInsert(callBack) {
			...
			if (M_Form_1_selectedRows_arr == null || M_Form_1_selectedRows_arr.length == 0) {
				SendToast('需要在[成员列表]中选择一条数据。', EToastType.Warning);return;
			}
			M_Dropdown_0_state = getStateByPath(M_Form_1_rowState, 'M_Dropdown_0', {});
			M_LC_6_state = getStateByPath(M_Form_1_rowState, 'M_LC_6', {});
			M_Dropdown_0_value = M_Dropdown_0_state.value;
			M_Text_0_state = getStateByPath(M_Form_1_rowState, 'M_Text_0', {});
			M_LC_5_state = getStateByPath(M_Form_1_rowState, 'M_LC_5', {});
			M_Text_0_value = M_Text_0_state.value;
			if (M_Form_0_selectedRows_arr == null || M_Form_0_selectedRows_arr.length == 0) {
				SendToast('需要在[所有小组]中选择一条数据。', EToastType.Warning);return;
			}
			M_Form_0_nowRecord = M_Form_0_state.records_arr[M_Form_0_selectedRows_arr[0]];
