...
var M_Text_0_style = { "max-width": "10em" };
		...
		value: function renderContent() {
			...
			retElem = React.createElement(
				...
				React.createElement(
					...
					React.createElement(VisibleERPC_Text, { className: "flex-grow-0 ", style: M_Text_0_style, id: "M_Text_0", parentPath: "M_Page_0", type: "date" }),
					React.createElement(
						"button",
						{ className: "flex-grow-1 btn btn-primary erp-control ", id: "button_1" },
						"\u540E\u4E00\u5929"
					)
				),
