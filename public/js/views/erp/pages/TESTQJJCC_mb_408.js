...
function bind_M_Form_8(retState, newIndex, oldIndex) {
	...
	var nowRecord = null;
	var useIndex = newIndex;
	needSetState['M_Text_21.value'] = null;
	if (records_arr == null || newIndex == -1 || records_arr.length == 0) {} else {
		nowRecord = records_arr[useIndex];
		...
		needSetState['M_LC_56.visible'] = M_LC_56_isdisplay_get(retState, bundle);
	}
	needSetState['nowRecord'] = nowRecord;
	needSetState['invalidbundle'] = false;
...
function M_LC_56_isdisplay_get(state, bundle) {
							...
							retElem = React.createElement(
								...
								React.createElement(
									...
									React.createElement(
										...
										React.createElement(VisibleERPC_Text, { id: "M_Text_21", parentPath: "M_Page_6.M_Form_8", type: "boolean" })
									),
									React.createElement(
										VisibleERPC_LabeledControl,
