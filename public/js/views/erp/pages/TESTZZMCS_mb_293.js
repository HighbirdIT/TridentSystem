...
function bind_M_Form_0(retState, newIndex, oldIndex) {
	...
	var needSetState = {};
	var bundle = {};
	needSetState['M_Text_0.value'] = 'haha';
	...
	_createClass(CM_Page_2, [{
		...
		value: function renderContent() {
			...
			retElem = React.createElement(
				...
				React.createElement(VisibleCM_Form_0, { id: 'M_Form_0', parentPath: 'M_Page_2' }),
				...
				if (this.props.fetchingErr) {
					...
					if (!this.props.loaded || this.props.fetching) {
						...
						retElem = React.createElement(
							...
							React.createElement(VisibleERPC_Text, { id: 'M_Text_0', parentPath: 'M_Page_2.M_Form_0', type: 'string', linetype: 'single' }),
...
var CM_Form_1 = function (_React$PureComponent4) {
	...
	function CM_Form_1(props) {
		...
		return _possibleConstructorReturn(this, (CM_Form_1.__proto__ || Object.getPrototypeOf(CM_Form_1)).call(this, props));
	}
