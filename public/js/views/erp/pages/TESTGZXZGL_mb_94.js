...
function active_M_Page_1(state) {
	...
	return initM_Page_1(state);
}
function initM_Page_1(state) {
	var needSetState = {};
...
var CM_Page_1 = function (_React$PureComponent10) {
	...
	_createClass(CM_Page_1, [{
		...
		value: function render() {
			...
			retElem = React.createElement(
				"div",
				{ className: "d-flex flex-column popPage bg-light p-1 border" },
				this.renderHead(),
				this.renderContent()
			);
			return retElem;
		...
		value: function renderContent() {
			...
			retElem = React.createElement(
				...
				React.createElement(
					VisibleERPC_Button,
					{ className: "btn btn-success erp-control ", id: "button_2", parentPath: "M_Page_1" },
					"\u786E\u8BA4\u63D0\u4EA4"
				),
				React.createElement(
					VisibleERPC_Button,
					{ className: "btn btn-danger erp-control ", id: "button_3", parentPath: "M_Page_1" },
					"\u653E\u5F03\u64CD\u4F5C"
				)
			);
			return retElem;
