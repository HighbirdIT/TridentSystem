...
var appStateChangedAct_map = { 'M_Page_0.M_Form_0.records_arr': fresh_M_Form_0.bind(window), 'M_Page_0.M_Form_0.pageIndex': bind_M_Form_0.bind(window), 'M_Page_0.M_Form_1.records_arr': fresh_M_Form_1.bind(window), 'M_Page_0.M_Form_1.pageIndex': bind_M_Form_1.bind(window),
	'M_Page_0.M_Form_0.selectedRows_arr': M_Page_0_M_Form_0_selectedRowsChanged.bind(window) };
var pageRouter = [];

function M_Page_0_M_Form_0_selectedRowsChanged(retState, newValue, oldValue, path, visited, delayActs, rowIndexInfo_map) {
...
function pull_M_Form_1(retState) {
	...
	if (M_Form_0_selectedRows_arr == null || M_Form_0_selectedRows_arr.length == 0) {
		needSetState.invalidbundle = true;
		return setManyStateByPath(state, 'M_Page_0.M_Form_1', needSetState);
	}
	var M_Form_0_selectedRecord = M_Form_0_state.records_arr[M_Form_0_selectedRows_arr[0]];
	var M_Form_0_selectedRowState = M_Form_0_state['row_' + M_Form_0_selectedRows_arr[0]];
	if (M_Form_0_selectedRowState == null) {
		needSetState.invalidbundle = true;
		return setManyStateByPath(state, 'M_Page_0.M_Form_1', needSetState);
	}
	console.log(M_Form_0_selectedRowState);

	var bundle = {};
	bundle.工作小组代码 = M_Form_0_selectedRecord.工作小组代码;
	setTimeout(function () {
