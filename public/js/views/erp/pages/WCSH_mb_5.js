					...
					retElem = React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								...
								React.createElement(VisibleERPC_Text, { id: 'M_Text_4', parentPath: 'M_Page_0.M_Form_0', type: 'date' })
							),
							React.createElement(
								VisibleERPC_LabeledControl,
								{ id: 'M_LC_4', parentPath: 'M_Page_0.M_Form_0', label: '\u5916\u51FA\u65F6\u95F4' },
								React.createElement(VisibleERPC_Text, { id: 'M_Text_8', parentPath: 'M_Page_0.M_Form_0', type: 'time' })
							),
							React.createElement(
								VisibleERPC_LabeledControl,
							...
							React.createElement(
								...
								React.createElement(VisibleERPC_Text, { id: 'M_Text_14', parentPath: 'M_Page_0.M_Form_0', type: 'time' })
							),
							React.createElement(
								VisibleERPC_LabeledControl,
