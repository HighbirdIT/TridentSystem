...
function bind_M_Form_0Page(retState) {
	...
	for (var rowIndex = startRowIndex; rowIndex <= endRowIndex; ++rowIndex) {
		...
		needSetState['row_' + rowIndex + '.M_Text_5.value'] = nowRecord['姓名'];
		needSetState['row_' + rowIndex + '.M_Text_6.value'] = nowRecord['员工假期种类代码'];
		needSetState['row_' + rowIndex + '.M_Text_7.value'] = nowRecord['登记确认时间'];
		needSetState['row_' + rowIndex + '.M_Text_8.value'] = nowRecord[' 员工登记姓名代码'];
	}
			...
			for (var rowIndex = startRowIndex; rowIndex <= endRowIndex; ++rowIndex) {
				trElems_arr.push(React.createElement(
					...
					React.createElement(
						...
						React.createElement(VisibleERPC_Text, { rowIndex: rowIndex, id: "M_Text_5", parentPath: "M_Page_2.M_Form_1.M_Form_0", type: "string", linetype: "single" })
					),
					React.createElement(
						"td",
						{ style: M_Form_0tdstyle4 },
						React.createElement(VisibleERPC_Text, { rowIndex: rowIndex, id: "M_Text_6", parentPath: "M_Page_2.M_Form_1.M_Form_0", type: "string", linetype: "single" })
					),
					React.createElement(
						"td",
						{ style: M_Form_0tdstyle5 },
						React.createElement(VisibleERPC_Text, { rowIndex: rowIndex, id: "M_Text_7", parentPath: "M_Page_2.M_Form_1.M_Form_0", type: "string", linetype: "single" })
					),
					React.createElement(
						"td",
						{ style: M_Form_0tdstyle6 },
						React.createElement(VisibleERPC_Text, { rowIndex: rowIndex, id: "M_Text_8", parentPath: "M_Page_2.M_Form_1.M_Form_0", type: "string", linetype: "single" })
					)
				));
			}
			return React.createElement(
