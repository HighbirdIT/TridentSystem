...
var M_Form_0headstyle0 = { "width": "25%", "maxWidth": "25%", "whiteSpace": "nowrap", "overflow": "hidden" };
var M_Form_0tdstyle0 = { "width": "25%", "maxWidth": "25%" };
var M_Form_0headstyle1 = { "width": "50%", "maxWidth": "50%", "whiteSpace": "nowrap", "overflow": "hidden" };
var M_Form_0tdstyle1 = { "width": "50%", "maxWidth": "50%" };
...
function bind_M_Form_0Page(retState) {
	...
	for (var rowIndex = startRowIndex; rowIndex <= endRowIndex; ++rowIndex) {
		...
		needSetState['row_' + rowIndex + '.M_Label_2.text'] = nowRecord['姓名'];
	...
	_createClass(CM_Form_0, [{
		...
		value: function renderContent() {
			...
			if (this.props.fetching) {
				retElem = renderFetcingTipDiv();
			} else if (this.props.invalidbundle) {
				retElem = renderInvalidBundleDiv();
			} else {
				if (this.props.fetchingErr) {
					retElem = renderFetcingErrDiv(this.props.fetchingErr.info);
