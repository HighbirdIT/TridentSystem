						...
						if (!this.props.canInsert && this.props.nowRecord == null) {
							...
							retElem = React.createElement(
								...
								React.createElement(
									...
									React.createElement(
										VisibleERPC_Button,
										{ className: "btn btn-primary erp-control ", id: "button_3", parentPath: "M_Page_2.M_Form_1", visible: false },
										"1"
									),
									React.createElement(
										VisibleERPC_Button,
										{ className: "btn btn-primary erp-control ", id: "button_2", parentPath: "M_Page_2.M_Form_1" },
										"\u5C0F\u59DC"
									),
									React.createElement(
										VisibleERPC_Button,
