...
var Redux = window.Redux;var Provider = ReactRedux.Provider;var isDebug = false;var appServerUrl = '/erppage/server/ZZMCS_server';var thisAppTitle = '赵智淼测试';var appInitState = { loaded: false, ui: {}, nowPage: 'M_Page_0' };var appReducerSetting = {};var appReducer = createReducer(appInitState, Object.assign(baseReducerSetting, appReducerSetting));;var reducer = Redux.combineReducers({ app: appReducer });;var store = Redux.createStore(reducer, Redux.applyMiddleware(logger, crashReporter, createThunkMiddleware()));;
var App = function (_React$PureComponent) {
  ...
  function App(props) {
    ...
    _this.renderLoadingTip = baseRenderLoadingTip.bind(_this);return _this;
  }

  _createClass(App, [{
    key: 'render',
    value: function render() {
      var retElem = null;retElem = React.createElement(
        'div',
...
function App_mapstatetoprops(state) {
  var retProps = {};return retProps;
}function App_disptchtoprops(dispatch, ownprops) {
  var retDispath = {};return retDispath;
...
var CM_Page_0 = function (_React$PureComponent2) {
  ...
  _createClass(CM_Page_0, [{
    key: 'render',
    value: function render() {
      var retElem = null;return retElem;
    }
  }]);
...
function CM_Page_0_mapstatetoprops(state) {
  ...
  var retDispath = {};return retDispath;
}var VisibleCM_Page_0 = ReactRedux.connect(CM_Page_0_mapstatetoprops, CM_Page_0_disptchtoprops)(CM_Page_0);ErpControlInit();ReactDOM.render(React.createElement(
  Provider,
  { store: store },
  '  ',
