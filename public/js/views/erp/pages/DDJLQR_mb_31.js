...
function button_2_onclick() {
	...
	if (M_Form_2_nowRecord['订单总金额'] == M_Form_2_nowRecord['审核认定金额'] && M_Form_2_nowRecord['审核确认说明'] == '同意') {
		var bundle_update_table_0 = {
							...
							retElem = React.createElement(
								...
								React.createElement(
									...
									React.createElement(
										...
										React.createElement(
											VisibleERPC_Button,
											{ className: "flex-grow-1 btn btn-danger erp-control ", id: "button_3", parentPath: "M_Page_1.M_Form_2", onClick: button_3_onclick },
											"\u4E0D\u540C\u610F"
										)
									),
