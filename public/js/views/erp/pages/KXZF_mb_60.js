	...
	if (M_Form_2_nowRecord['审核确认状态'] == 0) {
		...
		setTimeout(function () {
			...
			store.dispatch(fetchJsonPost(appServerUrl, { bundle: bundle_querysql_0, action: 'scriptBP_16_querysql_0' }, makeFTD_Callback(function (state, data_querysql_0, error_querysql_0) {
				...
				var ret = callback_final(state, data_querysql_0 + '在' + getFormatDateString(new Date(M_Form_2_nowRecord['登记确认时间'])) + (M_Form_2_nowRecord['审核确认状态'] == 1 ? '审核同意' : '审核拒绝'), null);
				return ret == null ? state : ret;
			}, false)));
		}, 50);
	}
}
function M_LC_22_isdisplay_get(state, bundle) {
	var M_Form_2_nowRecord = bundle != null && bundle.M_Form_2_nowRecord != null ? bundle.M_Form_2_nowRecord : getStateByPath(state, 'M_Page_1.M_Form_2.nowRecord');
	var validErr;
	var hadValidErr = false;
	var validErrState = {};
...
function button_0_onclick() {
	...
	var M_Label_13_state = getStateByPath(M_Form_2_state, 'M_Label_13', {});
	var M_LC_22_state = getStateByPath(M_Form_2_state, 'M_LC_22', {});
	var M_Label_13_text = M_Label_13_state.text;
	...
	if (M_Form_2_nowRecord['审核确认状态'] == 1) {
		var bundle_update_table_1 = {
			...
			M_Label_13_text: M_Label_13_text,
			复核确认状态: 1,
						...
						if (!this.props.canInsert && this.props.nowRecord == null) {
							...
							retElem = React.createElement(
								...
								React.createElement(
									...
									React.createElement(VisibleERPC_Label, { className: "text-danger erp-control ", id: "M_Label_15", parentPath: "M_Page_1.M_Form_2", type: "string" }),
									React.createElement(
										VisibleERPC_LabeledControl,
										{ id: "M_LC_22", parentPath: "M_Page_1.M_Form_2", label: "\u5BA1\u6838\u786E\u8BA4\u8BF4\u660E" },
										React.createElement(VisibleERPC_Label, { className: "erp-control ", id: "M_Label_13", parentPath: "M_Page_1.M_Form_2", type: "string" })
									),
									React.createElement(
										VisibleERPC_LabeledControl,
