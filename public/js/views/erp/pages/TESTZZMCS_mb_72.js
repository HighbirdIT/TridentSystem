	...
	_createClass(CM_Form_0, [{
		...
		value: function renderContent() {
			...
			retElem = React.createElement(
				...
				React.createElement(
					VisibleERPC_LabeledControl,
					{ id: 'M_LC_3', parentPath: 'M_Page_0.M_Form_0', label: '\u7528\u6237\u767B\u5F55\u540D\u79F0' },
					React.createElement(VisibleERPC_Label, { className: 'erp-control ', id: 'M_Label_4', parentPath: 'M_Page_0.M_Form_0', text: 'wer' })
				),
				React.createElement(
					VisibleERPC_LabeledControl,
