...
function bind_M_Form_1Page(retState) {
	...
	for (var rowIndex = startRowIndex; rowIndex <= endRowIndex; ++rowIndex) {
		...
		needSetState['row_' + rowIndex + '.M_Label_0.text'] = nowRecord['加入确认时间'];
	}
	needSetState.startRowIndex = startRowIndex;
	needSetState.endRowIndex = endRowIndex;
		...
		value: function render() {
			...
			for (var rowIndex = startRowIndex; rowIndex <= endRowIndex; ++rowIndex) {
				trElems_arr.push(React.createElement(
					...
					React.createElement(
						...
						React.createElement(VisibleERPC_Label, { className: "erp-control ", rowIndex: rowIndex, id: "M_Label_0", parentPath: "M_Page_0.M_Form_1", type: "date" })
					),
					React.createElement(
						"td",
						null,
			...
			if (this.props.hadNewRow) {
				...
				trElems_arr.push(React.createElement(
					...
					React.createElement("td", { style: M_Form_1tdstyle1 }),
					React.createElement(
						"td",
						null,
						React.createElement(VisibleERPC_GridForm_BtnCol, { rowIndex: rowIndex, form: this.props.form })
