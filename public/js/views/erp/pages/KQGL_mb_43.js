...
var appStateChangedAct_map = { 'M_Page_0.M_Form_0.M_Form_2.records_arr': fresh_M_Form_2.bind(window), 'M_Page_0.M_Form_0.M_Form_2.pageIndex': bind_M_Form_2.bind(window), 'M_Page_0.M_Form_0.M_Form_1.records_arr': fresh_M_Form_1.bind(window), 'M_Page_0.M_Form_0.M_Form_1.pageIndex': bind_M_Form_1.bind(window), 'M_Page_1.M_Form_3.records_arr': fresh_M_Form_3.bind(window), 'M_Page_1.M_Form_3.recordIndex': bind_M_Form_3.bind(window), 'M_Page_1.M_Form_3.M_Form_4.records_arr': fresh_M_Form_4.bind(window), 'M_Page_1.M_Form_3.M_Form_4.recordIndex': bind_M_Form_4.bind(window), 'M_Page_1.M_Form_3.M_Form_5.records_arr': fresh_M_Form_5.bind(window), 'M_Page_1.M_Form_3.M_Form_5.pageIndex': bind_M_Form_5.bind(window), 'M_Page_0.M_Form_0.M_Text_1.value': M_Text_1_value_changed.bind(window) };
var pageRouter = [];
...
function pull_M_Form_3(retState) {
	...
	retState = pull_M_Form_6(retState);
	return state;
}
...
function pull_M_Form_4(retState) {
	var hadStateParam = retState != null;
	var state = hadStateParam ? retState : store.getState();
	var M_Form_3_state = getStateByPath(state, 'M_Page_1.M_Form_3', {});
	var M_Label_8_state = getStateByPath(M_Form_3_state, 'M_Label_8', {});
	var M_LC_13_state = getStateByPath(M_Form_3_state, 'M_LC_13', {});
	var M_Label_8_text = M_Label_8_state.text;
	var M_Form_3_nowRecord = getStateByPath(M_Form_3_state, 'M_Page_1.M_Form_3.nowRecord');
	var validErr;
	var hadValidErr = false;
	var validErrState = {};
	if (IsEmptyString(M_Form_3_nowRecord)) {
		if (hadStateParam) {
			return setStateByPath(state, 'M_Page_1.M_Form_3.M_Form_4.invalidbundle', gPreconditionInvalidInfo);
		} else {
			store.dispatch(makeAction_setStateByPath(gPreconditionInvalidInfo, 'M_Page_1.M_Form_3.M_Form_4.invalidbundle'));
		}
	}
	if (hadValidErr) {
		if (hadStateParam) {
	...
	var bundle = {};
	bundle.M_Label_8_text = M_Label_8_text;
	bundle.员工登记姓名代码_12006 = M_Form_3_nowRecord.员工登记姓名代码;
	setTimeout(function () {
...
function pull_M_Form_6(retState) {
	var hadStateParam = retState != null;
	retState = bind_M_Form_6(retState);
	return retState;
}
...
function pull_M_Form_5(retState) {
	...
	var hadValidErr = false;
	var validErrState = {};
	if (IsEmptyString(M_Form_4_nowRecord) || IsEmptyString(M_Form_3_nowRecord)) {
		if (hadStateParam) {
							...
							retElem = React.createElement(
								...
								React.createElement(
									...
									React.createElement(
										...
										React.createElement(VisibleERPC_Label, { className: "erp-control ", id: "M_Label_8", parentPath: "M_Page_1.M_Form_3", type: "string" })
									),
									React.createElement(
										VisibleERPC_LabeledControl,
									...
									React.createElement(
										"div",
										{ className: "d-flex flex-grow-1 flex-shrink-1 erp-control flex-column " },
					...
					if (this.props.invalidbundle) {
						...
						retElem = React.createElement(
							...
							React.createElement(
								...
								React.createElement(
									VisibleERPC_LabeledControl,
									{ id: "M_LC_35", parentPath: "M_Page_1.M_Form_3.M_Form_6", label: "\u6BCF\u65E5\u603B\u7ED3" },
									React.createElement(VisibleERPC_Text, { id: "M_Text_0", parentPath: "M_Page_1.M_Form_3.M_Form_6", type: "string", linetype: "1x" })
								)
							),
							this.renderNavigater()
						);
...
var CM_Page_2 = function (_React$PureComponent17) {
	_inherits(CM_Page_2, _React$PureComponent17);
