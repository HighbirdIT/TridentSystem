...
function bind_M_Form_0(retState, newIndex, oldIndex) {
	...
	var needSetState = {};
	if (oldIndex == -1) {
		needSetState['insertCache.M_Label_1_text'] = getStateByPath(formState, 'M_Label_1.text');
		needSetState['insertCache.M_Label_4_text'] = getStateByPath(formState, 'M_Label_4.text');
		needSetState['insertCache.M_Label_3_text'] = getStateByPath(formState, 'M_Label_3.text');
		needSetState['insertCache.M_Label_2_text'] = getStateByPath(formState, 'M_Label_2.text');
	...
	if (records_arr == null || newIndex == -1) {
		insertCache = getStateByPath(formState, 'insertCache');
		if (insertCache) {
			needSetState['M_Label_1.text'] = insertCache.M_Label_1_text;
			needSetState['M_Label_4.text'] = insertCache.M_Label_4_text;
			needSetState['M_Label_3.text'] = insertCache.M_Label_3_text;
			needSetState['M_Label_2.text'] = insertCache.M_Label_2_text;
			needSetState['M_Text_2.value'] = insertCache.M_Text_2_value;
		} else {
			needSetState['M_Label_1.text'] = '';
			needSetState['M_Label_4.text'] = '';
			needSetState['M_Label_3.text'] = '';
			needSetState['M_Label_2.text'] = '';
		...
		needSetState['M_Label_3.text'] = nowRecord['员工登记性别'];
		...
		value: function renderContent() {
			...
			retElem = React.createElement(
				...
				React.createElement(
					...
					React.createElement(VisibleERPC_Label, { className: 'erp-control ', id: 'M_Label_0', parentPath: 'M_Page_0.M_Form_0', text: '2019-1-9' }),
					React.createElement('div', { className: 'flex-grow-1 d-flex flex-shrink-1 erp-control ' })
				),
				React.createElement(
				...
				React.createElement(
					VisibleERPC_LabeledControl,
					{ id: 'M_LC_3', parentPath: 'M_Page_0.M_Form_0', label: '\u8EAB\u4EFD\u8BC1\u4EF6\u53F7\u7801' },
					React.createElement(VisibleERPC_Label, { className: 'erp-control ', id: 'M_Label_4', parentPath: 'M_Page_0.M_Form_0' })
				),
				React.createElement(
					VisibleERPC_LabeledControl,
					{ id: 'M_LC_4', parentPath: 'M_Page_0.M_Form_0', label: '\u5458\u5DE5\u767B\u8BB0\u6027\u522B' },
					React.createElement(VisibleERPC_Label, { className: 'erp-control ', id: 'M_Label_3', parentPath: 'M_Page_0.M_Form_0' })
				),
				React.createElement(
					VisibleERPC_LabeledControl,
				...
				React.createElement('div', { className: 'd-flex flex-grow-1 flex-shrink-1 erp-control ' }),
