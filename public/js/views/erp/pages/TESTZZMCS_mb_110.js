...
var appStateChangedAct_map = { 'M_Page_0.M_Form_0.records_arr': fresh_M_Form_0.bind(window), 'M_Page_0.M_Form_0.recordIndex': bind_M_Form_0.bind(window), 'M_Page_0.M_Form_0.M_LC_3.label': M_LC_3_label_changed.bind(window), 'M_Page_0.M_Form_1.M_Text_0.value': M_Text_0_value_changed.bind(window), 'M_Page_0.M_Form_1.M_LC_4.label': M_LC_4_label_changed.bind(window) };
...
function M_LC_0_textfield_get(state, bundle) {
	var M_Form_0_state = getStateByPath(state, 'M_Page_0.M_Form_0');
	var M_LC_3_label = bundle != null && bundle['M_LC_3_label'] != null ? bundle['M_LC_3_label'] : getStateByPath(M_Form_0_state, 'M_LC_3.label');
	return M_LC_3_label + 10;
}
...
function M_Text_1_textfield_get(state, bundle) {
	var M_Form_1_state = getStateByPath(state, 'M_Page_0.M_Form_1');
	var M_Text_0_value = bundle != null && bundle['M_Text_0_value'] != null ? bundle['M_Text_0_value'] : getStateByPath(M_Form_1_state, 'M_Text_0.value');
	return M_Text_0_value * 2;
}
function M_Label_3_textfield_get(state, bundle) {
	var M_Form_1_state = getStateByPath(state, 'M_Page_0.M_Form_1');
	var M_LC_4_label = bundle != null && bundle['M_LC_4_label'] != null ? bundle['M_LC_4_label'] : getStateByPath(M_Form_1_state, 'M_LC_4.label');
	return M_LC_4_label * 3;
}
function M_LC_3_label_changed(state, newValue, oldValue, path, visited, delayActs) {
	var needSetState = {};
	needSetState['M_Page_0.M_Form_0.M_LC_0.label'] = M_LC_0_textfield_get(state);
...
function M_Text_0_value_changed(state, newValue, oldValue, path, visited, delayActs) {
	var needSetState = {};
	needSetState['M_Page_0.M_Form_1.M_Text_1.value'] = M_Text_1_textfield_get(state);
	return setManyStateByPath(state, '', needSetState);
}
function M_LC_4_label_changed(state, newValue, oldValue, path, visited, delayActs) {
	var needSetState = {};
	needSetState['M_Page_0.M_Form_1.M_Label_3.text'] = M_Label_3_textfield_get(state);
	return setManyStateByPath(state, '', needSetState);
}
	...
	_createClass(CM_Form_0, [{
		...
		value: function renderContent() {
			...
			retElem = React.createElement(
				...
				React.createElement(
					VisibleERPC_LabeledControl,
					{ id: 'M_LC_0', parentPath: 'M_Page_0.M_Form_0' },
	...
	_createClass(CM_Form_1, [{
		...
		value: function renderContent() {
			...
			retElem = React.createElement(
				...
				React.createElement(
					VisibleERPC_LabeledControl,
					{ id: 'M_LC_5', parentPath: 'M_Page_0.M_Form_1', label: 'A*2' },
					React.createElement(VisibleERPC_Text, { id: 'M_Text_1', parentPath: 'M_Page_0.M_Form_1', type: 'float', precision: '2' })
				),
				React.createElement(
					VisibleERPC_LabeledControl,
					{ id: 'M_LC_6', parentPath: 'M_Page_0.M_Form_1', label: 'A*3' },
					React.createElement(VisibleERPC_Label, { className: 'erp-control ', id: 'M_Label_3', parentPath: 'M_Page_0.M_Form_1' })
				),
				this.renderNavigater()
			);
			return retElem;
