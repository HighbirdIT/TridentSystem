...
var appStateChangedAct_map = { 'M_Page_0.M_Form_0.records_arr': fresh_M_Form_0.bind(window), 'M_Page_0.M_Form_0.recordIndex': bind_M_Form_0.bind(window), 'M_Page_0.M_Form_0.M_LC_1.label': M_LC_1_label_changed.bind(window), 'M_Page_0.M_Form_1.M_LC_4.label': M_LC_4_label_changed.bind(window) };
...
function M_LC_0_textfield_get(state, bundle) {
	...
	var M_LC_1_textfield = bundle != null && bundle['M_LC_1_textfield'] != null ? bundle['M_LC_1_textfield'] : getStateByPath(M_Form_0_state, 'M_Page_0.M_Form_0.M_LC_1.textfield');
	return M_LC_1_textfield + 10;
}
...
function M_LC_1_label_changed(state, newValue, oldValue, path, visited, delayActs) {
	var needSetState = {};
