...
var M_Form_4headstyle0 = { "width": "12.5%", "maxWidth": "12.5%", "whiteSpace": "nowrap", "overflow": "hidden" };
var M_Form_4tdstyle0 = { "width": "12.5%", "maxWidth": "12.5%" };
var M_Form_4headstyle1 = { "width": "37.5%", "maxWidth": "37.5%", "whiteSpace": "nowrap", "overflow": "hidden" };
var M_Form_4tdstyle1 = { "width": "37.5%", "maxWidth": "37.5%" };
var M_Form_4_tableStyle = { "marginTop": "-50px" };
var M_Form_4_headtableStyle = { "marginBottom": "0px" };
...
var M_Form_5headstyle1 = { "width": "42.9%", "maxWidth": "42.9%", "whiteSpace": "nowrap", "overflow": "hidden" };
var M_Form_5tdstyle1 = { "width": "42.9%", "maxWidth": "42.9%" };
...
var appReducerSetting = { AT_PAGELOADED: pageLoadedReducer.bind(window), AT_GOTOPAGE: gotoPageReducer.bind(window), ReBindM_Form_1Page: bind_M_Form_1Page.bind(window), ReBindM_Form_2Page: bind_M_Form_2Page.bind(window), ReBindM_Form_4Page: bind_M_Form_4Page.bind(window), ReBindM_Form_5Page: bind_M_Form_5Page.bind(window) };
...
var appStateChangedAct_map = { 'M_Page_0.M_Form_0.M_Form_1.records_arr': fresh_M_Form_1.bind(window), 'M_Page_0.M_Form_0.M_Form_1.pageIndex': bind_M_Form_1.bind(window), 'M_Page_0.M_Form_0.M_Form_2.records_arr': fresh_M_Form_2.bind(window), 'M_Page_0.M_Form_0.M_Form_2.pageIndex': bind_M_Form_2.bind(window), 'M_Page_0.M_Form_3.M_Form_4.records_arr': fresh_M_Form_4.bind(window), 'M_Page_0.M_Form_3.M_Form_4.pageIndex': bind_M_Form_4.bind(window), 'M_Page_0.M_Form_3.M_Form_5.records_arr': fresh_M_Form_5.bind(window), 'M_Page_0.M_Form_3.M_Form_5.pageIndex': bind_M_Form_5.bind(window), 'M_Page_0.M_Form_0.M_Text_0.value': M_Text_0_value_changed.bind(window), 'M_Page_0.M_Form_0.M_Text_1.value': M_Text_1_value_changed.bind(window), 'M_Page_0.M_Form_3.M_Text_3.value': M_Text_3_value_changed.bind(window), 'M_Page_0.M_Form_3.M_Text_5.value': M_Text_5_value_changed.bind(window), 'M_Page_0.M_Form_0.M_Text_2.value': M_Text_2_value_changed.bind(window) };
var pageRouter = [];
...
function M_Text_5_defaultvalue_get(state, bundle) {
	var id;
	...
	var M_Text_3_value = bundle != null && bundle['M_Text_3_value'] != null ? bundle['M_Text_3_value'] : M_Text_3_state.value;
	var validErr;
	var hadValidErr = false;
	var validErrState = {};
	var callback_final = function callback_final(state, data, err) {
		...
		needSetState.fetching = false;
		needSetState.fetchingErr = err;
		return setManyStateByPath(state, 'M_Page_0.M_Form_3.M_Text_5', needSetState);
	};
	validErr = BaseIsValueValid(state, M_LC_14_state, M_Text_3_state, M_Text_3_value, 'int', false, 'M_Text_3', validErrState);
	...
	var fetchid = Math.round(Math.random() * 999999);
	fetchTracer['M_Text_5_defaultvalue_get'] = fetchid;
	state = setManyStateByPath(state, 'M_Page_0.M_Form_3.M_Text_5', { fetching: true, fetchingErr: null });
	var bundle_querysql_0 = {
		报销记录代码: M_Text_3_value
	};
	setTimeout(function () {
		if (fetchTracer['M_Text_5_defaultvalue_get'] != fetchid) return;
		store.dispatch(fetchJsonPost(appServerUrl, { bundle: bundle_querysql_0, action: 'scriptBP_3_querysql_0' }, makeFTD_Callback(function (state, data_querysql_0, error_querysql_0) {
			...
			var ret = callback_final(state, id, null);
			return ret == null ? state : ret;
		}, false)));
	}, 50);
}
...
function bind_M_Form_4(retState, newIndex, oldIndex) {
	var formState = getStateByPath(retState, 'M_Page_0.M_Form_3.M_Form_4', {});
	var records_arr = formState.records_arr;
	var needSetState = {};
	var bundle = {};
	var needActiveBindPage = true;
	needSetState['invalidbundle'] = false;
	retState = setManyStateByPath(retState, 'M_Page_0.M_Form_3.M_Form_4', needSetState);
	return bind_M_Form_4Page(retState);
	retState = setManyStateByPath(retState, 'M_Page_0.M_Form_3.M_Form_4', needSetState);
	return retState;
}
function pull_M_Form_4(retState) {
	...
	if (hadValidErr) {
		if (hadStateParam) {
			return setStateByPath(state, 'M_Page_0.M_Form_3.M_Form_4.invalidbundle', gPreconditionInvalidInfo);
		} else {
			store.dispatch(makeAction_setStateByPath(gPreconditionInvalidInfo, 'M_Page_0.M_Form_3.M_Form_4.invalidbundle'));
		}
		return;
	}
	var bundle = {};
	bundle.M_Text_3_value = M_Text_3_value;
	setTimeout(function () {
		store.dispatch(fetchJsonPost(appServerUrl, { bundle: bundle, action: 'pulldata_M_Form_4' }, makeFTD_Prop('M_Page_0.M_Form_3', 'M_Form_4', 'records_arr', false), EFetchKey.FetchPropValue));
	}, 50);
	return state;
}
function bind_M_Form_4Page(retState) {
	var formState = getStateByPath(retState, 'M_Page_0.M_Form_3.M_Form_4', {});
	var records_arr = formState.records_arr;
	var needSetState = {};
	var startRowIndex = 0;
	...
	for (var rowIndex = startRowIndex; rowIndex <= endRowIndex; ++rowIndex) {
		var nowRecord = records_arr[rowIndex];
		needSetState['row_' + rowIndex + '.M_Label_13.text'] = nowRecord['凭证统计年份'];
		needSetState['row_' + rowIndex + '.M_Label_14.text'] = nowRecord['凭证统计月份'];
		needSetState['row_' + rowIndex + '.M_Label_15.text'] = nowRecord['凭证流水号码'];
		needSetState['row_' + rowIndex + '.M_Label_18.text'] = nowRecord['借方发生金额'];
		needSetState['row_' + rowIndex + '.M_Label_16.text'] = nowRecord['凭证内容说明'];
		needSetState['row_' + rowIndex + '.M_Label_17.text'] = nowRecord['所属公司名称代码'];
	}
	needSetState.startRowIndex = startRowIndex;
	needSetState.endRowIndex = endRowIndex;
	return setManyStateByPath(retState, 'M_Page_0.M_Form_3.M_Form_4', needSetState);
}
function fresh_M_Form_5(retState, records_arr) {
	bind_M_Form_5(retState);
}
function bind_M_Form_5(retState, newIndex, oldIndex) {
	var formState = getStateByPath(retState, 'M_Page_0.M_Form_3.M_Form_5', {});
	var records_arr = formState.records_arr;
	var needSetState = {};
	var bundle = {};
	var needActiveBindPage = true;
	needSetState['invalidbundle'] = false;
	retState = setManyStateByPath(retState, 'M_Page_0.M_Form_3.M_Form_5', needSetState);
...
function pull_M_Form_5(retState) {
	...
	var state = hadStateParam ? retState : store.getState();
	var M_Form_3_state = getStateByPath(state, 'M_Page_0.M_Form_3', {});
	var M_Text_5_state = getStateByPath(M_Form_3_state, 'M_Text_5', {});
	var M_LC_16_state = getStateByPath(M_Form_3_state, 'M_LC_16', {});
	var M_Text_5_value = M_Text_5_state.value;
	var validErr;
	var hadValidErr = false;
	var validErrState = {};
	validErr = BaseIsValueValid(state, M_LC_16_state, M_Text_5_state, M_Text_5_value, 'int', false, 'M_Text_5', validErrState);
	validErrState['M_Page_0.M_Form_3.M_Text_5.invalidInfo'] = validErr;
	if (validErr != null) hadValidErr = true;
	if (hadValidErr) {
		if (hadStateParam) {
			return setStateByPath(state, 'M_Page_0.M_Form_3.M_Form_5.invalidbundle', gPreconditionInvalidInfo);
		} else {
			store.dispatch(makeAction_setStateByPath(gPreconditionInvalidInfo, 'M_Page_0.M_Form_3.M_Form_5.invalidbundle'));
		}
		return;
	}
	var bundle = {};
	bundle.M_Text_5_value = M_Text_5_value;
	setTimeout(function () {
		store.dispatch(fetchJsonPost(appServerUrl, { bundle: bundle, action: 'pulldata_M_Form_5' }, makeFTD_Prop('M_Page_0.M_Form_3', 'M_Form_5', 'records_arr', false), EFetchKey.FetchPropValue));
	}, 50);
	return state;
}
function bind_M_Form_5Page(retState) {
	...
	for (var rowIndex = startRowIndex; rowIndex <= endRowIndex; ++rowIndex) {
		var nowRecord = records_arr[rowIndex];
		needSetState['row_' + rowIndex + '.M_Label_19.text'] = nowRecord['凭证明细记录代码'];
		needSetState['row_' + rowIndex + '.M_Label_20.text'] = nowRecord['子目流水号码'];
		needSetState['row_' + rowIndex + '.M_Label_21.text'] = nowRecord['科目方向名称'];
		needSetState['row_' + rowIndex + '.M_Label_22.text'] = nowRecord['凭证摘要说明'];
		needSetState['row_' + rowIndex + '.M_Label_23.text'] = nowRecord['记帐发生金额'];
	}
	needSetState.startRowIndex = startRowIndex;
	needSetState.endRowIndex = endRowIndex;
	return setManyStateByPath(retState, 'M_Page_0.M_Form_3.M_Form_5', needSetState);
}
...
function M_Text_3_value_changed(state, newValue, oldValue, path, visited, delayActs) {
	var needSetState = {};
	needSetState['M_Page_0.M_Form_3.M_Text_5.value'] = M_Text_5_defaultvalue_get(state);
	if (delayActs['call_pull_M_Form_4'] == null) {
		delayActs['call_pull_M_Form_4'] = { callfun: pull_M_Form_4 };
	};
	return setManyStateByPath(state, '', needSetState);
}
function M_Text_5_value_changed(state, newValue, oldValue, path, visited, delayActs) {
	var needSetState = {};
					...
					if (this.props.invalidbundle) {
						...
						retElem = React.createElement(
							...
							React.createElement(
								...
								React.createElement(VisibleCM_Form_4, { id: "M_Form_4", parentPath: "M_Page_0.M_Form_3", pagebreak: false, reBindAT: "ReBindM_Form_4Page" }),
								React.createElement(VisibleCM_Form_5, { id: "M_Form_5", parentPath: "M_Page_0.M_Form_3", pagebreak: false, reBindAT: "ReBindM_Form_5Page" })
							),
							this.renderNavigater()
						);
					}
...
var CM_Form_4 = function (_React$PureComponent11) {
	...
	function CM_Form_4(props) {
		...
		_this11.tableBodyScroll = _this11.tableBodyScroll.bind(_this11);
		return _this11;
	}
	...
	_createClass(CM_Form_4, [{
		...
		key: "tableBodyScroll",
		value: function tableBodyScroll(ev) {
			document.getElementById('M_Form_4tableheader').scrollLeft = ev.target.scrollLeft;
		}
	}, {
		key: "renderContent",
		value: function renderContent() {
				...
				if (this.props.fetchingErr) {
					...
					if (this.props.invalidbundle) {
						...
						if (!this.props.canInsert && (this.props.records_arr == null || this.props.records_arr.length == 0)) {
							...
							retElem = React.createElement(CM_Form_4_TBody, { startRowIndex: this.props.startRowIndex, endRowIndex: this.props.endRowIndex });
							if (this.props.pagebreak) {
								navElem = React.createElement(CBaseGridFormNavBar, { pageIndex: this.props.pageIndex, rowPerPage: this.props.rowPerPage, rowPerPageChangedHandler: this.rowPerPageChangedHandler, pageCount: this.props.pageCount, prePageClickHandler: this.prePageClickHandler, nxtPageClickHandler: this.nxtPageClickHandler, pageIndexChangedHandler: this.pageIndexChangedHandler });
							}
						}
			...
			return React.createElement(
				...
				React.createElement(
					"div",
					{ id: "M_Form_4tableheader", className: "mw-100 hidenOverflow flex-shrink-0" },
					React.createElement(
						"table",
						{ className: "table", style: M_Form_4_headtableStyle },
						React.createElement(CM_Form_4_THead, null)
					)
				),
				React.createElement(
					"div",
...
function CM_Form_4_mapstatetoprops(state, ownprops) {
	var retProps = {};
	var ctlState = getStateByPath(state, 'M_Page_0.M_Form_3.M_Form_4', {});
	retProps.fetching = ctlState.fetching;
	retProps.fetchingErr = ctlState.fetchingErr;
	retProps.records_arr = ctlState.records_arr;
	retProps.recordIndex = ctlState.recordIndex;
...
var CM_Form_4_THead = function (_React$PureComponent12) {
	_inherits(CM_Form_4_THead, _React$PureComponent12);

	function CM_Form_4_THead(props) {
		_classCallCheck(this, CM_Form_4_THead);

		return _possibleConstructorReturn(this, (CM_Form_4_THead.__proto__ || Object.getPrototypeOf(CM_Form_4_THead)).call(this, props));
	}

	_createClass(CM_Form_4_THead, [{
		key: "render",
		value: function render() {
			var retElem = null;
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						"th",
						{ scope: "col", style: M_Form_4headstyle0 },
						"\u5E74\u4EFD"
					),
					React.createElement(
						"th",
					...
					React.createElement(
						"th",
						{ scope: "col", style: M_Form_4headstyle1 },
						"\u8BF4\u660E"
					),
					React.createElement(
						"th",
	...
	return CM_Form_4_THead;
}(React.PureComponent);

var CM_Form_4_TBody = function (_React$PureComponent13) {
	_inherits(CM_Form_4_TBody, _React$PureComponent13);

	function CM_Form_4_TBody(props) {
		_classCallCheck(this, CM_Form_4_TBody);

		return _possibleConstructorReturn(this, (CM_Form_4_TBody.__proto__ || Object.getPrototypeOf(CM_Form_4_TBody)).call(this, props));
	}

	_createClass(CM_Form_4_TBody, [{
		key: "render",
		value: function render() {
			var retElem = null;
			var trElems_arr = [];
			...
			for (var rowIndex = startRowIndex; rowIndex <= endRowIndex; ++rowIndex) {
				trElems_arr.push(React.createElement(
					...
					React.createElement(
						"td",
						{ style: M_Form_4tdstyle0 },
						React.createElement(VisibleERPC_Label, { className: "erp-control ", rowIndex: rowIndex, id: "M_Label_13", parentPath: "M_Page_0.M_Form_3.M_Form_4", type: "string" })
					),
					React.createElement(
						"td",
						{ style: M_Form_4tdstyle0 },
						React.createElement(VisibleERPC_Label, { className: "erp-control ", rowIndex: rowIndex, id: "M_Label_14", parentPath: "M_Page_0.M_Form_3.M_Form_4", type: "string" })
					),
					React.createElement(
						"td",
						{ style: M_Form_4tdstyle0 },
						React.createElement(VisibleERPC_Label, { className: "erp-control ", rowIndex: rowIndex, id: "M_Label_15", parentPath: "M_Page_0.M_Form_3.M_Form_4", type: "string" })
					),
					React.createElement(
						"td",
						{ style: M_Form_4tdstyle0 },
						React.createElement(VisibleERPC_Label, { className: "erp-control ", rowIndex: rowIndex, id: "M_Label_18", parentPath: "M_Page_0.M_Form_3.M_Form_4", type: "string" })
					),
					React.createElement(
						"td",
						{ style: M_Form_4tdstyle1 },
						React.createElement(VisibleERPC_Label, { className: "erp-control ", rowIndex: rowIndex, id: "M_Label_16", parentPath: "M_Page_0.M_Form_3.M_Form_4", type: "string" })
					),
					React.createElement(
						"td",
						{ style: M_Form_4tdstyle0 },
						React.createElement(VisibleERPC_Label, { className: "erp-control ", rowIndex: rowIndex, id: "M_Label_17", parentPath: "M_Page_0.M_Form_3.M_Form_4", type: "string" })
					)
				));
			}
			return React.createElement(
				"table",
				{ className: "table table-striped table-hover ", style: M_Form_4_tableStyle },
				React.createElement(CM_Form_4_THead, null),
				React.createElement(
					"tbody",
					null,
...
function CM_Form_5_mapstatetoprops(state, ownprops) {
	var retProps = {};
	var ctlState = getStateByPath(state, 'M_Page_0.M_Form_3.M_Form_5', {});
	retProps.fetching = ctlState.fetching;
	retProps.fetchingErr = ctlState.fetchingErr;
	retProps.records_arr = ctlState.records_arr;
	retProps.recordIndex = ctlState.recordIndex;
			...
			for (var rowIndex = startRowIndex; rowIndex <= endRowIndex; ++rowIndex) {
				trElems_arr.push(React.createElement(
					...
					React.createElement(
						...
						React.createElement(VisibleERPC_Label, { className: "erp-control ", rowIndex: rowIndex, id: "M_Label_19", parentPath: "M_Page_0.M_Form_3.M_Form_5", type: "string" })
					),
					React.createElement(
						"td",
						{ style: M_Form_5tdstyle0 },
						React.createElement(VisibleERPC_Label, { className: "erp-control ", rowIndex: rowIndex, id: "M_Label_20", parentPath: "M_Page_0.M_Form_3.M_Form_5", type: "string" })
					),
					React.createElement(
						"td",
						{ style: M_Form_5tdstyle0 },
						React.createElement(VisibleERPC_Label, { className: "erp-control ", rowIndex: rowIndex, id: "M_Label_21", parentPath: "M_Page_0.M_Form_3.M_Form_5", type: "string" })
					),
					React.createElement(
						"td",
						{ style: M_Form_5tdstyle1 },
						React.createElement(VisibleERPC_Label, { className: "erp-control ", rowIndex: rowIndex, id: "M_Label_22", parentPath: "M_Page_0.M_Form_3.M_Form_5", type: "string" })
					),
					React.createElement(
						"td",
						{ style: M_Form_5tdstyle0 },
						React.createElement(VisibleERPC_Label, { className: "erp-control ", rowIndex: rowIndex, id: "M_Label_23", parentPath: "M_Page_0.M_Form_3.M_Form_5", type: "string" })
					)
				));
			}
			return React.createElement(
