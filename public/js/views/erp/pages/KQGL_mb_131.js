...
function M_Label_8_textfield_get(state, bundle) {
	...
	setTimeout(function () {
		...
		store.dispatch(fetchJsonPost(appServerUrl, { bundle: bundle_querysql_0, action: 'scriptBP_18_querysql_0' }, makeFTD_Callback(function (state, data_querysql_0, error_querysql_0) {
			...
			return '本条记录在' + getFormatDateString(castDate(querysql_0_登记确认时间)) + '已经被' + querysql_0_登记确认人员 + '认定完成，已经无需再进行认定';
		}, false)));
	}, 50);
}
						...
						if (!this.props.canInsert && this.props.nowRecord == null) {
							...
							retElem = React.createElement(
								...
								React.createElement(
									...
									React.createElement(VisibleERPC_Label, { className: "erp-control ", id: "M_Label_8", parentPath: "M_Page_1.M_Form_4", type: "string" }),
									React.createElement(
										VisibleERPC_Button,
