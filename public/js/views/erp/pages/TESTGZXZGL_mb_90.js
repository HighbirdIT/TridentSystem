		...
		value: function renderContent() {
			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						VisibleERPC_Button,
						{ className: "btn btn-primary erp-control ", rowIndex: rowIndex, id: "button_0", parentPath: "M_Page_0.M_Form_1" },
						"\u8C03\u5165\u6210\u5458"
					),
					React.createElement(
						VisibleERPC_Button,
						{ className: "btn btn-warning erp-control ", rowIndex: rowIndex, id: "button_1", parentPath: "M_Page_0.M_Form_1" },
						"\u8C03\u51FA\u6210\u5458"
					)
				),
				navElem
