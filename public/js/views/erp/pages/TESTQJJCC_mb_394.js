...
function M_LC_56_isdisplay_get(state, bundle) {
	...
	return M_Form_8_nowRecord['是否返回'] == true;
}
					...
					if (this.props.invalidbundle) {
						...
						retElem = React.createElement(
							...
							React.createElement(
								...
								React.createElement(
									VisibleERPC_LabeledControl,
									{ id: "M_LC_43", parentPath: "M_Page_5.M_Form_7", label: "\u5DE5\u4F5C\u5730\u70B9" },
									React.createElement(VisibleERPC_DropDown, { id: "M_Dropdown_7", parentPath: "M_Page_5.M_Form_7", pullDataSource: pull_M_Dropdown_7, textAttrName: "\u5E38\u4F4F\u5DE5\u4F5C\u5730\u70B9", valueAttrName: "\u5E38\u4F4F\u5DE5\u4F5C\u5730\u70B9\u4EE3\u7801", label: "\u5DE5\u4F5C\u5730\u70B9" })
								),
								React.createElement(
									VisibleERPC_LabeledControl,
