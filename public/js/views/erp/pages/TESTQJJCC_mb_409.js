...
function bind_M_Form_8(retState, newIndex, oldIndex) {
	...
	if (records_arr == null || newIndex == -1 || records_arr.length == 0) {} else {
		...
		needSetState['M_Label_26.text'] = nowRecord['前往地域名称'];
		needSetState['M_Label_27.text'] = nowRecord['前往地点名称'];
		needSetState['M_Label_28.text'] = nowRecord['是否返回驻地'];
						...
						if (!this.props.canInsert && this.props.nowRecord == null) {
							...
							retElem = React.createElement(
								...
								React.createElement(
									...
									React.createElement(
										VisibleERPC_LabeledControl,
										{ id: "M_LC_52", parentPath: "M_Page_6.M_Form_8", label: "\u524D\u5F80\u5730\u57DF\u540D\u79F0" },
									...
									React.createElement(
										...
										React.createElement(VisibleERPC_Label, { className: "erp-control ", id: "M_Label_28", parentPath: "M_Page_6.M_Form_8", type: "string" })
									),
									React.createElement(
										VisibleERPC_LabeledControl,
