...
function bind_M_Form_2(retState, newIndex, oldIndex) {
	...
	needSetState['M_Text_0.value'] = 'wer3';
						...
						if (!this.props.canInsert && this.props.nowRecord == null) {
							...
							retElem = React.createElement(
								...
								React.createElement(
									...
									React.createElement(
										VisibleERPC_LabeledControl,
										{ id: "M_LC_22", parentPath: "M_Page_0.M_Form_2", label: "test23f" },
										React.createElement(VisibleERPC_Text, { id: "M_Text_0", parentPath: "M_Page_0.M_Form_2", type: "string", linetype: "single" })
									),
									React.createElement(
										VisibleERPC_LabeledControl,
