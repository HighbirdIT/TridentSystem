...
function bind_M_Form_0(retState, newIndex, oldIndex) {
	...
	if (records_arr == null || newIndex == -1 || records_arr.length == 0) {} else {
		...
		needSetState['M_Text_3.value'] = nowRecord['企业实付金额'];
		needSetState['M_Text_4.value'] = nowRecord['个人实付金额'];
		needSetState['M_Text_5.value'] = nowRecord['用券抵扣金额'];
		needSetState['M_Text_6.value'] = nowRecord['实际里程数'];
		needSetState['M_Text_7.value'] = nowRecord['开始计费时间'];
		needSetState['M_Text_8.value'] = nowRecord['结束计费时间'];
		needSetState['M_Text_9.value'] = nowRecord['时长'];
		needSetState['M_Text_11.value'] = nowRecord['用车城市'];
		needSetState['M_Text_12.value'] = nowRecord['出发地地址'];
		needSetState['M_Text_10.value'] = nowRecord['目的地地址'];
	}
...
function bind_M_Form_1Page(retState) {
	...
	for (var rowIndex = startRowIndex; rowIndex <= endRowIndex; ++rowIndex) {
		...
		needSetState['row_' + rowIndex + '.M_Text_13.value'] = nowRecord['记录种类名称'];
		needSetState['row_' + rowIndex + '.M_Text_14.value'] = nowRecord['记录开始时间'];
		needSetState['row_' + rowIndex + '.M_Text_15.value'] = nowRecord['记录结束时间'];
		needSetState['row_' + rowIndex + '.M_Text_16.value'] = nowRecord['记录开始地点'];
	}
							...
							retElem = React.createElement(
								...
								React.createElement(
									...
									React.createElement(
										...
										React.createElement(
											"button",
											{ className: "flex-grow-1 btn btn-danger erp-control ", id: "button_1" },
											"\u79C1\u4EBA\u7528\u8F66"
										)
									),
			...
			for (var rowIndex = startRowIndex; rowIndex <= endRowIndex; ++rowIndex) {
				trElems_arr.push(React.createElement(
					...
					React.createElement(
						...
						React.createElement(VisibleERPC_Text, { rowIndex: rowIndex, id: "M_Text_13", parentPath: "M_Page_0.M_Form_0.M_Form_1", type: "string", linetype: "single" })
					),
					React.createElement(
						"td",
						{ style: M_Form_1tdstyle0 },
						React.createElement(VisibleERPC_Text, { rowIndex: rowIndex, id: "M_Text_14", parentPath: "M_Page_0.M_Form_0.M_Form_1", type: "string", linetype: "single" })
					),
					React.createElement(
						"td",
						{ style: M_Form_1tdstyle0 },
						React.createElement(VisibleERPC_Text, { rowIndex: rowIndex, id: "M_Text_15", parentPath: "M_Page_0.M_Form_0.M_Form_1", type: "string", linetype: "single" })
					),
					React.createElement(
						"td",
						{ style: M_Form_1tdstyle0 },
						React.createElement(VisibleERPC_Text, { rowIndex: rowIndex, id: "M_Text_16", parentPath: "M_Page_0.M_Form_0.M_Form_1", type: "string", linetype: "single" })
					)
				));
			}
			return React.createElement(
