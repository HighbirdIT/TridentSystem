		...
		value: function renderContent() {
			...
			retElem = React.createElement(
				...
				React.createElement(
					...
					React.createElement("button", { className: "flex-grow-1 btn btn-success erp-control ", id: "button_0" }),
					React.createElement(VisibleERPC_Text, { style: M_Text_0_style, id: "M_Text_0", parentPath: "M_Page_0", type: "date" }),
					React.createElement("button", { className: "flex-grow-1 btn btn-primary erp-control ", id: "button_1" })
				),
