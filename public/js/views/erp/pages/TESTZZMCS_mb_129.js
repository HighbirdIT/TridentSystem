...
function button_0_onclik() {
	...
	store.dispath(makeAction_setStateByPath(Date.parse(M_Text_0_value).setDate(Date.parse(M_Text_0_value).getDate() + -1), 'M_Page_0.M_Text_0.value'));
}
		...
		value: function renderContent() {
			...
			retElem = React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						"button",
						{ className: "flex-grow-1 btn btn-dark erp-control ", id: "button_1" },
						"\u540E\u4E00\u5929"
					)
				),
