...
var appStateChangedAct_map = { 'M_Page_0.M_Form_0.records_arr': fresh_M_Form_0.bind(window), 'M_Page_0.M_Form_0.recordIndex': bind_M_Form_0.bind(window), 'M_Page_0.M_Form_1.M_Text_0.value': M_Text_0_value_changed.bind(window) };
...
function M_LC_3_textfield_get(state, bundle) {
	...
	var M_LC_0_label = bundle != null && bundle['M_LC_0_label'] != null ? bundle['M_LC_0_label'] : getStateByPath(M_Form_0_state, 'M_LC_0.label');
	var M_Form_0_nowrecord = bundle != null && bundle.M_Form_0_nowrecord != null ? bundle.M_Form_0_nowrecord : getStateByPath(M_Form_0_state, 'M_Page_0.M_Form_0.nowRecord');
	return M_Form_0_nowrecord['员工登记姓名'] + '我不信你的生日是' + M_LC_0_label;
}
