...
var isDebug = false;
var appServerUrl = '/erppage/server/XTFAGL';
var thisAppTitle = '系统方案管理';
...
function bind_M_Form_0(retState, newIndex, oldIndex) {
	...
	needSetState['M_CheckBox_0.value'] = '1';
...
function button_0_onclick() {
	...
	var callback_final = function callback_final(state, data, err) {
		...
		if (err) {
			if (scriptBP_0_msg) {
				scriptBP_0_msg.setData(err.info, EMessageBoxType.Error, '登记确认');
			} else {
	...
	validErr = BaseIsValueValid(state, M_LC_1_state, M_Dropdown_0_state, M_Dropdown_0_value, 'string', false, 'M_Dropdown_0', validErrState);
	validErrState['M_Page_0.M_Form_0.M_Dropdown_0.invalidInfo'] = validErr;
	if (validErr != null) hadValidErr = true;
	validErr = BaseIsValueValid(state, M_LC_2_state, M_CheckBox_0_state, M_CheckBox_0_value, 'string', false, 'M_CheckBox_0', validErrState);
	...
	scriptBP_0_msg = PopMessageBox('', EMessageBoxType.Loading, '登记确认');;
					...
					if (this.props.invalidbundle) {
						...
						retElem = React.createElement(
							...
							React.createElement(
								...
								{ id: 'M_LC_0', parentPath: 'M_Page_0.M_Form_0', label: '\u7CFB\u7EDF\u65B9\u6848\u540D\u79F0' },
								React.createElement(VisibleERPC_Text, { id: 'M_Text_0', parentPath: 'M_Page_0.M_Form_0', type: 'string', linetype: 'single' })
							),
							React.createElement(
								VisibleERPC_LabeledControl,
								{ id: 'M_LC_1', parentPath: 'M_Page_0.M_Form_0', label: '\u7CFB\u7EDF\u6D41\u7A0B\u540D\u79F0' },
								React.createElement(VisibleERPC_DropDown, { id: 'M_Dropdown_0', parentPath: 'M_Page_0.M_Form_0', pullDataSource: pull_M_Dropdown_0, textAttrName: '\u7CFB\u7EDF\u6D41\u7A0B\u540D\u79F0', valueAttrName: '\u7CFB\u7EDF\u6D41\u7A0B\u540D\u79F0\u4EE3\u7801', label: '\u7CFB\u7EDF\u6D41\u7A0B\u540D\u79F0' })
							),
							React.createElement(
								VisibleERPC_LabeledControl,
								{ id: 'M_LC_2', parentPath: 'M_Page_0.M_Form_0', label: '\u662F\u5426\u5217\u8868\u53EF\u89C1' },
								React.createElement(VisibleERPC_CheckBox, { id: 'M_CheckBox_0', parentPath: 'M_Page_0.M_Form_0' })
							),
							React.createElement(
								VisibleERPC_LabeledControl,
								{ id: 'M_LC_3', parentPath: 'M_Page_0.M_Form_0', label: '\u79FB\u52A8\u7AEFLN' },
								React.createElement(VisibleERPC_DropDown, { id: 'M_Dropdown_1', parentPath: 'M_Page_0.M_Form_0', pullDataSource: pull_M_Dropdown_1, textAttrName: '\u6A21\u677F\u540D\u79F0', label: '\u79FB\u52A8\u7AEFLN' })
							),
							React.createElement(
								VisibleERPC_LabeledControl,
								{ id: 'M_LC_4', parentPath: 'M_Page_0.M_Form_0', label: '\u684C\u9762\u7AEFLN' },
								React.createElement(VisibleERPC_DropDown, { id: 'M_Dropdown_2', parentPath: 'M_Page_0.M_Form_0', pullDataSource: pull_M_Dropdown_2, textAttrName: '\u6A21\u677F\u540D\u79F0', label: '\u684C\u9762\u7AEFLN' })
							),
							React.createElement(
								'button',
...
function KMP(targetStr, searchStr) {
	var next_arr = getNext(searchStr);
	var i = 0;
	var k = 0;
	while (k < searchStr.length && k < targetStr.length) {
		if (k == -1 || targetStr[i] == searchStr[k]) {
			++i;
			++k;
		} else {
			k = next_arr[k];
	...
	return k == searchStr.length ? i - searchStr.length : -1;
}
...
console.log(KMP('abcdjifabcdabce', 'abcdabce'));