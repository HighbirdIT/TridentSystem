...
var appStateChangedAct_map = { 'M_Page_2.M_Form_1.records_arr': fresh_M_Form_1.bind(window), 'M_Page_2.M_Form_1.recordIndex': bind_M_Form_1.bind(window), 'M_Page_2.M_Dropdown_0.value': M_Dropdown_0_value_changed.bind(window) };
...
function pull_M_Form_1(retState) {
	...
	if (IsEmptyString(bundle.M_Dropdown_0_value)) {
		...
		value: function renderContent() {
			...
			retElem = React.createElement(
				...
				React.createElement(
					...
					React.createElement(VisibleERPC_DropDown, { id: "M_Dropdown_0", parentPath: "M_Page_2", groupAttr: "\u5458\u5DE5\u5DE5\u65F6\u72B6\u6001,\u6240\u5C5E\u7CFB\u7EDF\u540D\u79F0", pullDataSource: pull_M_Dropdown_0, textAttrName: "\u5458\u5DE5\u767B\u8BB0\u59D3\u540D", valueAttrName: "\u5458\u5DE5\u767B\u8BB0\u59D3\u540D\u4EE3\u7801", label: "\u8BF7\u5047\u4EBA\u5458" })
				),
