...
var M_Form_1headstyle1 = { "width": "38.5%", "maxWidth": "38.5%", "whiteSpace": "nowrap", "overflow": "hidden" };
var M_Form_1tdstyle1 = { "width": "38.5%", "maxWidth": "38.5%" };
var M_Form_1headstyle2 = { "width": "7.7%", "maxWidth": "7.7%", "whiteSpace": "nowrap", "overflow": "hidden" };
var M_Form_1tdstyle2 = { "width": "7.7%", "maxWidth": "7.7%" };
...
function bind_M_Form_1Page(retState) {
	...
	for (var rowIndex = startRowIndex; rowIndex <= endRowIndex; ++rowIndex) {
		...
		needSetState['row_' + rowIndex + '.M_Text_0.value'] = nowRecord['事由要求用途'];
			...
			for (var rowIndex = startRowIndex; rowIndex <= endRowIndex; ++rowIndex) {
				trElems_arr.push(React.createElement(
					...
					React.createElement(
						...
						React.createElement(VisibleERPC_Text, { rowIndex: rowIndex, id: "M_Text_0", parentPath: "M_Page_0.M_Form_0.M_Form_1", type: "string", linetype: "single" })
					),
					React.createElement(
						"td",
