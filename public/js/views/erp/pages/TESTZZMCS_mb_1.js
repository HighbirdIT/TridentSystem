...
var M_Form_0headstyle0 = { "width": "39.6%", "maxWidth": "39.6%", "whiteSpace": "nowrap", "overflow": "hidden" };
var M_Form_0tdstyle0 = { "width": "39.6%", "maxWidth": "39.6%" };
var M_Form_0headstyle1 = { "width": "29.7%", "maxWidth": "29.7%", "whiteSpace": "nowrap", "overflow": "hidden" };
var M_Form_0tdstyle1 = { "width": "29.7%", "maxWidth": "29.7%" };
...
function bind_M_Form_0Page(retState) {
	...
	for (var rowIndex = startRowIndex; rowIndex <= endRowIndex; ++rowIndex) {
		...
		needSetState['row_' + rowIndex + '.M_Text_0.value'] = nowRecord['员工登记姓名代码'];
		needSetState['row_' + rowIndex + '.M_Text_1.value'] = nowRecord['考勤登记日期'];
		needSetState['row_' + rowIndex + '.M_Text_2.value'] = nowRecord['补登考勤时间'];
	}
			...
			for (var rowIndex = startRowIndex; rowIndex <= endRowIndex; ++rowIndex) {
				trElems_arr.push(React.createElement(
					...
					React.createElement(
						...
						React.createElement(VisibleERPC_Text, { rowIndex: rowIndex, id: "M_Text_0", parentPath: "M_Page_0.M_Form_0", type: "string", linetype: "single" })
					),
					React.createElement(
						"td",
					...
					React.createElement(
						"td",
						{ style: M_Form_0tdstyle1 },
						React.createElement(VisibleERPC_Text, { rowIndex: rowIndex, id: "M_Text_2", parentPath: "M_Page_0.M_Form_0", type: "string", linetype: "single" })
					)
				));
			}
			return React.createElement(
