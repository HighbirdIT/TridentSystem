...
var M_Form_1headstyle1 = { "width": "23.1%", "maxWidth": "23.1%", "whiteSpace": "nowrap", "overflow": "hidden" };
var M_Form_1tdstyle1 = { "width": "23.1%", "maxWidth": "23.1%" };
...
function M_Text_1_defaultvalue_get(state, bundle) {
	...
	setTimeout(function () {
		...
		store.dispatch(fetchJsonPost(appServerUrl, { bundle: bundle_querysql_0, action: 'scriptBP_1_querysql_0' }, makeFTD_Callback(function (state, data_querysql_0, error_querysql_0) {
			...
			var ret = callback_final(state, data_querysql_0, error_querysql_0);
...
function bind_M_Form_1Page(retState) {
	...
	for (var rowIndex = startRowIndex; rowIndex <= endRowIndex; ++rowIndex) {
		...
		needSetState['row_' + rowIndex + '.M_Text_3.value'] = nowRecord['年份'];
		needSetState['row_' + rowIndex + '.M_Text_4.value'] = nowRecord['月份'];
		needSetState['row_' + rowIndex + '.M_Text_5.value'] = nowRecord['流水号'];
		needSetState['row_' + rowIndex + '.M_Text_8.value'] = nowRecord['金额'];
		needSetState['row_' + rowIndex + '.M_Text_6.value'] = nowRecord['说明'];
		needSetState['row_' + rowIndex + '.M_Text_7.value'] = nowRecord['公司'];
	}
			...
			for (var rowIndex = startRowIndex; rowIndex <= endRowIndex; ++rowIndex) {
				trElems_arr.push(React.createElement(
					...
					React.createElement(
						...
						React.createElement(VisibleERPC_Text, { rowIndex: rowIndex, id: "M_Text_3", parentPath: "M_Page_0.M_Form_0.M_Form_1", type: "string", linetype: "single" })
					),
					React.createElement(
						"td",
						{ style: M_Form_1tdstyle0 },
						React.createElement(VisibleERPC_Text, { rowIndex: rowIndex, id: "M_Text_4", parentPath: "M_Page_0.M_Form_0.M_Form_1", type: "string", linetype: "single" })
					),
					React.createElement(
						"td",
						{ style: M_Form_1tdstyle1 },
						React.createElement(VisibleERPC_Text, { rowIndex: rowIndex, id: "M_Text_5", parentPath: "M_Page_0.M_Form_0.M_Form_1", type: "string", linetype: "single" })
					),
					React.createElement(
						"td",
						{ style: M_Form_1tdstyle0 },
						React.createElement(VisibleERPC_Text, { rowIndex: rowIndex, id: "M_Text_8", parentPath: "M_Page_0.M_Form_0.M_Form_1", type: "string", linetype: "single" })
					),
					React.createElement(
						"td",
						{ style: M_Form_1tdstyle0 },
						React.createElement(VisibleERPC_Text, { rowIndex: rowIndex, id: "M_Text_6", parentPath: "M_Page_0.M_Form_0.M_Form_1", type: "string", linetype: "single" })
					),
					React.createElement(
						"td",
						{ style: M_Form_1tdstyle0 },
						React.createElement(VisibleERPC_Text, { rowIndex: rowIndex, id: "M_Text_7", parentPath: "M_Page_0.M_Form_0.M_Form_1", type: "string", linetype: "single" })
					)
				));
			}
			return React.createElement(
