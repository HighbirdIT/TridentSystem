...
var appStateChangedAct_map = { 'M_Page_0.M_Form_0.M_Form_2.records_arr': fresh_M_Form_2.bind(window), 'M_Page_0.M_Form_0.M_Form_2.pageIndex': bind_M_Form_2.bind(window), 'M_Page_0.M_Form_0.M_Form_1.records_arr': fresh_M_Form_1.bind(window), 'M_Page_0.M_Form_0.M_Form_1.pageIndex': bind_M_Form_1.bind(window), 'M_Page_1.M_Form_4.records_arr': fresh_M_Form_4.bind(window), 'M_Page_1.M_Form_4.recordIndex': bind_M_Form_4.bind(window), 'M_Page_1.M_Form_4.M_Form_5.records_arr': fresh_M_Form_5.bind(window), 'M_Page_1.M_Form_4.M_Form_5.pageIndex': bind_M_Form_5.bind(window), 'M_Page_1.M_Text_2.value': M_Text_2_value_changed.bind(window), 'M_Page_0.M_Form_0.M_Text_1.value': M_Text_1_value_changed.bind(window) };
var pageRouter = [];
...
function button_6_onclick() {
	...
	if (getFormatDateString(new Date(new Date(M_Text_2_value).setDate(new Date(M_Text_2_value).getDate() + 1))) > getFormatDateString(getNowDate())) {
		setTimeout(function () {
...
function button_2_onclick() {
	...
	setTimeout(function () {
		...
		store.dispatch(fetchJsonPost(appServerUrl, { bundle: bundle_querysql_0, action: 'scriptBP_16_querysql_0' }, makeFTD_Callback(function (state, data_querysql_0, error_querysql_0) {
			...
			if (M_Text_2_value > getFormatDateString(data_querysql_0).setDate(getFormatDateString(data_querysql_0).getDate() + 1)) {
				var ret = callback_final(state, null, '当前日期不是最小可认定日期，最小可认定日期为' + data_querysql_0);
				return ret == null ? state : ret;
			} else {
				var bundle_insert_table_0 = {
					员工登记姓名代码: g_envVar.userid,
							...
							retElem = React.createElement(
								...
								React.createElement(
									...
									React.createElement(
										...
										React.createElement(VisibleERPC_Label, { className: "erp-control ", id: "M_Label_20", parentPath: "M_Page_1.M_Form_4", type: "string" })
									),
									React.createElement(
										VisibleERPC_LabeledControl,
										{ id: "M_LC_26", parentPath: "M_Page_1.M_Form_4", label: "\u662F\u5426\u8BA4\u5B9A\u65E9\u9000" },
										React.createElement(VisibleERPC_Label, { className: "erp-control ", id: "M_Label_21", parentPath: "M_Page_1.M_Form_4", type: "string" })
									),
									React.createElement(
										VisibleERPC_LabeledControl,
										{ id: "M_LC_27", parentPath: "M_Page_1.M_Form_4", label: "\u662F\u5426\u8BA4\u5B9A\u79BB\u5C97" },
										React.createElement(VisibleERPC_Label, { className: "erp-control ", id: "M_Label_22", parentPath: "M_Page_1.M_Form_4", type: "string" })
									),
									React.createElement(
										VisibleERPC_LabeledControl,
										{ id: "M_LC_28", parentPath: "M_Page_1.M_Form_4", label: "\u662F\u5426\u5DF2\u7ECF\u8BA4\u5B9A" },
										React.createElement(VisibleERPC_Label, { className: "erp-control ", id: "M_Label_23", parentPath: "M_Page_1.M_Form_4", type: "string" })
									),
									React.createElement(
										VisibleERPC_LabeledControl,
									...
									React.createElement(VisibleCM_Form_5, { id: "M_Form_5", parentPath: "M_Page_1.M_Form_4", title: "\u5458\u5DE5\u884C\u8E2A\u8BB0\u5F55", pagebreak: true, reBindAT: "ReBindM_Form_5Page" }),
									React.createElement(
										VisibleERPC_Button,
