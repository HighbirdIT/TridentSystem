...
function button_2_onclick() {
	...
	var M_Text_5_state = getStateByPath(M_Form_2_state, 'M_Text_5', {});
	var M_LC_40_state = getStateByPath(M_Form_2_state, 'M_LC_40', {});
	...
	if (validErr != null) hadValidErr = true;
	validErr = BaseIsValueValid(state, M_LC_40_state, M_Text_5_state, M_Text_5_value, 'string', false, 'M_Text_5', validErrState);
	validErrState['M_Page_1.M_Form_2.M_Text_5.invalidInfo'] = validErr;
	if (validErr != null) hadValidErr = true;
	if (hadValidErr) {
		return callback_final(null, null, { info: gPreconditionInvalidInfo });
	}
	...
	if (M_Form_2_nowRecord['订单总金额'] == M_Text_7_value) {
		var bundle_update_table_0 = {
...
function button_3_onclick() {
	...
	var M_LC_44_state = getStateByPath(M_Form_2_state, 'M_LC_44', {});
	...
	validErr = BaseIsValueValid(state, M_LC_44_state, M_Text_9_state, M_Text_9_value, 'string', false, 'M_Text_9', validErrState);
	validErrState['M_Page_1.M_Form_2.M_Text_9.invalidInfo'] = validErr;
	if (validErr != null) hadValidErr = true;
	validErr = BaseIsValueValid(state, M_LC_37_state, M_Text_2_state, M_Text_2_value, 'float', false, 'M_Text_2', validErrState);
	validErrState['M_Page_1.M_Form_2.M_Text_2.invalidInfo'] = validErr;
	if (validErr != null) hadValidErr = true;
...
function button_5_onclick() {
	...
	if (M_Form_2_nowRecord['最终确认说明'] == '无') {
		...
		var bundle_update_table_0 = {
			...
			M_Text_3_value: M_Text_3_value,
			最终确认状态: 1,
			最终确认金额: M_Form_2_nowRecord['订单总金额'],
...
function button_6_onclick() {
	...
	if (M_Form_2_nowRecord['最终确认说明'] == '无') {
		...
		var bundle_update_table_0 = {
			...
			M_Text_3_value: M_Text_3_value,
			最终确认状态: 2,
			最终确认金额: M_Form_2_nowRecord['审核认定金额'],
			M_Form_2_滴滴乘车记录代码: M_Form_2_nowRecord['滴滴乘车记录代码'],
