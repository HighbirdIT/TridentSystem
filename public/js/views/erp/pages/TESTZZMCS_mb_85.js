...
var appStateChangedAct_map = { 'M_Page_0.M_Form_0.records_arr': fresh_M_Form_0.bind(window), 'M_Page_0.M_Form_0.recordIndex': bind_M_Form_0.bind(window), 'M_Page_0.M_Form_1.records_arr': fresh_M_Form_1.bind(window), 'M_Page_0.M_Form_1.recordIndex': bind_M_Form_1.bind(window) };
...
function fresh_M_Form_1(retState, records_arr) {
	simpleFreshFormFun(retState, records_arr, 'M_Page_0.M_Form_1');
}
function bind_M_Form_1(retState, newIndex, oldIndex) {
	...
	if (nowRecord) {} else {
		needSetState['M_LC_5.label'] = M_LC_5_textfield_get(retState, bundle);
	}
	setManyStateByPath(retState, 'M_Page_0.M_Form_1', needSetState);
}
