...
var M_Form_0tdstyle0 = { "width": "10%", "maxWidth": "10%", "verticalAlign": "middle" };
var M_Form_0headstyle1 = { "width": "40%", "maxWidth": "40%", "whiteSpace": "nowrap", "overflow": "hidden" };
var M_Form_0tdstyle1 = { "width": "40%", "maxWidth": "40%", "verticalAlign": "middle" };
var M_Form_0headstyle2 = { "width": "50%", "maxWidth": "50%", "whiteSpace": "nowrap", "overflow": "hidden" };
var M_Form_0tdstyle2 = { "width": "50%", "maxWidth": "50%", "verticalAlign": "middle" };
...
var M_Form_3tdstyle0 = { "width": "10%", "maxWidth": "10%", "verticalAlign": "middle" };
var M_Form_3headstyle1 = { "width": "40%", "maxWidth": "40%", "whiteSpace": "nowrap", "overflow": "hidden" };
var M_Form_3tdstyle1 = { "width": "40%", "maxWidth": "40%", "verticalAlign": "middle" };
var M_Form_3headstyle2 = { "width": "50%", "maxWidth": "50%", "whiteSpace": "nowrap", "overflow": "hidden" };
var M_Form_3tdstyle2 = { "width": "50%", "maxWidth": "50%", "verticalAlign": "middle" };
...
var M_Form_5tdstyle0 = { "width": "33.3%", "maxWidth": "33.3%", "verticalAlign": "middle" };
...
function pull_M_Form_0(retState, holdSelected) {
	...
	setTimeout(function () {
		if (!holdSelected) {
			store.dispatch(makeAction_setStateByPath(null, 'M_Page_2.M_Form_1.M_Form_0.selectedRows_arr'));
		}
...
function M_Text_4_defaultvalue_get(state, bundle) {
	...
	var fetchKey = M_Text_4_defaultvalue_get;
	fetchTracer[fetchKey] = fetchid;
	var baseBundle = {};
	state = setManyStateByPath(state, 'M_Page_2.M_Form_1.M_Text_4', { fetching: true, fetchingErr: null });
	var bundle_queryfb_0 = Object.assign({}, baseBundle, {
		M_Dropdown_0_value: M_Dropdown_0_value,
		M_Dropdown_1_value: M_Dropdown_1_value
	});
	setTimeout(function () {
		if (fetchTracer[fetchKey] != fetchid) return;
		store.dispatch(fetchJsonPost(appServerUrl, { bundle: bundle_queryfb_0, action: 'scriptBP_18_queryfb_0' }, makeFTD_Callback(function (state, data_queryfb_0, error_queryfb_0) {
			if (error_queryfb_0) {
...
function button_4_onclick() {
	...
	if (fetchTracer[fetchKey] != fetchid) return;
	store.dispatch(fetchJsonPost(appServerUrl, { bundle: bundle_querysql_0, action: 'scriptBP_21_querysql_0' }, makeFTD_Callback(function (state, data_querysql_0, error_querysql_0) {
		if (error_querysql_0) {
...
function bind_M_Form_2(retState, newIndex, oldIndex) {
	...
	if (records_arr == null || newIndex == -1 || records_arr.length == 0) {} else {
		...
		needSetState['M_LC_15.visible'] = M_LC_15_isdisplay_get(retState, bundle);
	}
...
function pull_M_Form_2(retState, holdSelected) {
	var hadStateParam = retState != null;
	var state = hadStateParam ? retState : store.getState();
	var bundle = {};
	setTimeout(function () {
...
function M_LC_14_isdisplay_get(state, bundle) {
	...
	var M_Form_2_nowRecord = getStateByPath(M_Form_2_state, 'M_Page_0.M_Form_2.nowRecord');
	var validErr;
	var hadValidErr = false;
	var validErrState = {};
	var callback_final = function callback_final(state, data, err) {
...
function M_LC_15_isdisplay_get(state, bundle) {
	var M_Form_2_state = getStateByPath(state, 'M_Page_0.M_Form_2', {});
	var M_Form_2_nowRecord = getStateByPath(M_Form_2_state, 'M_Page_0.M_Form_2.nowRecord');
	var validErr;
	var hadValidErr = false;
...
function button_0_onclick() {
	...
	var bundle_update_table_0 = Object.assign({}, baseBundle, {
		M_Form_2_nowRecord: M_Form_2_nowRecord,
...
function pull_M_Form_3(retState, holdSelected) {
	var hadStateParam = retState != null;
	var state = hadStateParam ? retState : store.getState();
	var M_Form_2_state = getStateByPath(state, 'M_Page_0.M_Form_2', {});
	var M_Form_2_nowRecord = getStateByPath(M_Form_2_state, 'M_Page_0.M_Form_2.nowRecord');
	...
	setTimeout(function () {
		if (!holdSelected) {
			store.dispatch(makeAction_setStateByPath(null, 'M_Page_0.M_Form_2.M_Form_3.selectedRows_arr'));
		}
...
function pull_M_Form_4(retState, holdSelected) {
	var hadStateParam = retState != null;
...
function pull_M_Dropdown_2(parentPath) {
	var rowIndexInfo_map = getRowIndexMapFromPath(parentPath);
	var bundle = {};
	var useState = store.getState();
	store.dispatch(fetchJsonPost(appServerUrl, { bundle: bundle, action: 'pulldata_M_Dropdown_2' }, makeFTD_Prop(parentPath, 'M_Dropdown_2', 'options_arr', false), EFetchKey.FetchPropValue));
}
...
function pull_M_Dropdown_3(parentPath) {
	var rowIndexInfo_map = getRowIndexMapFromPath(parentPath);
	var bundle = {};
	var useState = store.getState();
	store.dispatch(fetchJsonPost(appServerUrl, { bundle: bundle, action: 'pulldata_M_Dropdown_3' }, makeFTD_Prop(parentPath, 'M_Dropdown_3', 'options_arr', false), EFetchKey.FetchPropValue));
}
function pull_M_Dropdown_4(parentPath) {
	var rowIndexInfo_map = getRowIndexMapFromPath(parentPath);
	var bundle = {};
	var useState = store.getState();
	store.dispatch(fetchJsonPost(appServerUrl, { bundle: bundle, action: 'pulldata_M_Dropdown_4' }, makeFTD_Prop(parentPath, 'M_Dropdown_4', 'options_arr', false), EFetchKey.FetchPropValue));
}
function pull_M_Dropdown_5(parentPath) {
	var rowIndexInfo_map = getRowIndexMapFromPath(parentPath);
	var bundle = {};
	var useState = store.getState();
	store.dispatch(fetchJsonPost(appServerUrl, { bundle: bundle, action: 'pulldata_M_Dropdown_5' }, makeFTD_Prop(parentPath, 'M_Dropdown_5', 'options_arr', false), EFetchKey.FetchPropValue));
}
function button_2_onclick() {
	...
	if (fetchTracer[fetchKey] != fetchid) return;
	store.dispatch(fetchJsonPost(appServerUrl, { bundle: bundle_querysql_0, action: 'scriptBP_29_querysql_0' }, makeFTD_Callback(function (state, data_querysql_0, error_querysql_0) {
		if (error_querysql_0) {
			return callback_final(state, null, error_querysql_0);
		}
		if (data_querysql_0.length > 0) {
...
function pull_M_Form_5(retState, holdSelected) {
	var hadStateParam = retState != null;
	var state = hadStateParam ? retState : store.getState();
	var M_Form_4_state = getStateByPath(state, 'M_Page_1.M_Form_4', {});
	var M_Dropdown_2_state = getStateByPath(M_Form_4_state, 'M_Dropdown_2', {});
	...
	setTimeout(function () {
		if (!holdSelected) {
			store.dispatch(makeAction_setStateByPath(null, 'M_Page_1.M_Form_4.M_Form_5.selectedRows_arr'));
		}
...
function active_M_Page_3(state) {
	...
	return init_M_Page_3(state);
}
function init_M_Page_3(state) {
	var needSetState = [];
	var hadState = state != null;
	if (!hadState) {
		state = store.getState();
...
function button_9_onclick() {
	var state = store.getState();
	setTimeout(function () {
		store.dispatch(makeAction_gotoPage('M_Page_5'));
	}, 50);
}
function active_M_Page_4(state) {
	...
	return init_M_Page_4(state);
}
function init_M_Page_4(state) {
	var needSetState = [];
	var hadState = state != null;
	if (!hadState) {
		state = store.getState();
...
function pull_M_Form_6(retState, holdSelected) {
	var hadStateParam = retState != null;
	var state = hadStateParam ? retState : store.getState();
	var bundle = {};
	setTimeout(function () {
...
function button_7_onclick() {
	...
	var M_Form_6_nowRecord = getStateByPath(M_Form_6_state, 'M_Page_4.M_Form_6.nowRecord');
	...
	var fetchid = Math.round(Math.random() * 999999);
	var fetchKey = button_7_onclick;
	fetchTracer[fetchKey] = fetchid;
	var baseBundle = {};
	scriptBP_36_msg = PopMessageBox('', EMessageBoxType.Loading, '批准出差');
	var bundle_update_table_0 = Object.assign({}, baseBundle, {
		M_Form_6_nowRecord: M_Form_6_nowRecord,
...
function active_M_Page_5(state) {
	...
	return init_M_Page_5(state);
}
function init_M_Page_5(state) {
	var needSetState = [];
	var hadState = state != null;
	if (!hadState) {
		state = store.getState();
...
function bind_M_Form_7(retState, newIndex, oldIndex) {
	...
	needSetState['M_Text_13.value'] = M_Text_13_defaultvalue_get(retState, bundle);
...
function pull_M_Form_7(retState, holdSelected) {
	var hadStateParam = retState != null;
...
function pull_M_Dropdown_6(parentPath) {
	var rowIndexInfo_map = getRowIndexMapFromPath(parentPath);
	var bundle = {};
	var useState = store.getState();
	store.dispatch(fetchJsonPost(appServerUrl, { bundle: bundle, action: 'pulldata_M_Dropdown_6' }, makeFTD_Prop(parentPath, 'M_Dropdown_6', 'options_arr', false), EFetchKey.FetchPropValue));
}
function M_Text_12_defaultvalue_get(state, bundle) {
	return getFormatDateString(getNowDate());
}
function M_Text_13_defaultvalue_get(state, bundle) {
...
function M_Dropdown_7_defaultvalue_get(state, bundle) {
	...
	var M_Dropdown_6_value = bundle != null && bundle['M_Dropdown_6_value'] != null ? bundle['M_Dropdown_6_value'] : M_Dropdown_6_state.value;
	var validErr;
	var hadValidErr = false;
	var validErrState = {};
	var callback_final = function callback_final(state, data, err) {
		...
		needSetState.fetching = false;
		needSetState.fetchingErr = err;
		return setManyStateByPath(state, 'M_Page_5.M_Form_7.M_Dropdown_7', needSetState);
	};
	...
	var fetchid = Math.round(Math.random() * 999999);
	var fetchKey = M_Dropdown_7_defaultvalue_get;
	fetchTracer[fetchKey] = fetchid;
	var baseBundle = {};
	state = setManyStateByPath(state, 'M_Page_5.M_Form_7.M_Dropdown_7', { fetching: true, fetchingErr: null });
	var bundle_querysql_0 = Object.assign({}, baseBundle, {
		M_Dropdown_6_value: M_Dropdown_6_value
	});
	setTimeout(function () {
		if (fetchTracer[fetchKey] != fetchid) return;
		store.dispatch(fetchJsonPost(appServerUrl, { bundle: bundle_querysql_0, action: 'scriptBP_40_querysql_0' }, makeFTD_Callback(function (state, data_querysql_0, error_querysql_0) {
			if (error_querysql_0) {
				return callback_final(state, null, error_querysql_0);
			}
...
function pull_M_Dropdown_7(parentPath) {
	var rowIndexInfo_map = getRowIndexMapFromPath(parentPath);
	var bundle = {};
	var useState = store.getState();
	store.dispatch(fetchJsonPost(appServerUrl, { bundle: bundle, action: 'pulldata_M_Dropdown_7' }, makeFTD_Prop(parentPath, 'M_Dropdown_7', 'options_arr', false), EFetchKey.FetchPropValue));
}
function M_LC_47_isdisplay_get(state, bundle) {
	var M_Form_7_state = getStateByPath(state, 'M_Page_5.M_Form_7', {});
...
function M_Text_18_validchecker(nowValue, comeState, comeValidErrState) {
	var state = store.getState();
	var M_Form_7_state = getStateByPath(state, 'M_Page_5.M_Form_7', {});
	var M_Text_13_state = getStateByPath(M_Form_7_state, 'M_Text_13', {});
	var M_LC_42_state = getStateByPath(M_Form_7_state, 'M_LC_42', {});
	...
	if (validErrState.hasOwnProperty('M_Page_5.M_Form_7.M_Text_13.invalidInfo')) {
		validErr = validErrState['M_Page_5.M_Form_7.M_Text_13.invalidInfo'];
	} else {
		validErr = BaseIsValueValid(comeState, M_LC_42_state, M_Text_13_state, M_Text_13_value, 'time', false, 'M_Text_13', validErrState);
		validErrState['M_Page_5.M_Form_7.M_Text_13.invalidInfo'] = validErr;
	}
	if (validErr != null) hadValidErr = true;
	if (hadValidErr) {
		return callback_final(null, null, { info: gPreconditionInvalidInfo });
	}
	if (nowValue <= M_Text_13_value) {
		return '返回时间必需大于外出时间。';
	}
}
function pull_M_Dropdown_9(parentPath) {
	var rowIndexInfo_map = getRowIndexMapFromPath(parentPath);
	var bundle = {};
	var useState = store.getState();
	store.dispatch(fetchJsonPost(appServerUrl, { bundle: bundle, action: 'pulldata_M_Dropdown_9' }, makeFTD_Prop(parentPath, 'M_Dropdown_9', 'options_arr', false), EFetchKey.FetchPropValue));
}
function button_8_onclick() {
	...
	if (validErr != null) hadValidErr = true;
	validErr = BaseIsValueValid(state, M_LC_42_state, M_Text_13_state, M_Text_13_value, 'time', false, 'M_Text_13', validErrState);
	validErrState['M_Page_5.M_Form_7.M_Text_13.invalidInfo'] = validErr;
	if (validErr != null) hadValidErr = true;
...
function active_M_Page_6(state) {
	...
	return init_M_Page_6(state);
}
function init_M_Page_6(state) {
	var needSetState = [];
	var hadState = state != null;
	if (!hadState) {
		state = store.getState();
...
function bind_M_Form_8(retState, newIndex, oldIndex) {
	...
	var nowRecord = null;
	var useIndex = newIndex;
	needSetState['M_Text_11.value'] = '同意';
	if (records_arr == null || newIndex == -1 || records_arr.length == 0) {} else {
		nowRecord = records_arr[useIndex];
		bundle.M_Form_8_nowRecord = nowRecord;
		needSetState['M_Label_23.text'] = nowRecord['申请人姓名'];
		needSetState['M_Label_24.text'] = nowRecord['申请外出日期'];
		needSetState['M_Label_25.text'] = nowRecord['申请外出时间'];
		needSetState['M_Label_26.text'] = nowRecord['当前工作地点'];
		needSetState['M_Label_27.text'] = nowRecord['前往地点名称'];
		needSetState['M_CheckBox_1.value'] = nowRecord['是否返回驻地'];
		needSetState['M_Label_29.text'] = nowRecord['预计返回时间'];
		needSetState['M_Label_30.text'] = nowRecord['用车需求'];
		needSetState['M_Label_31.text'] = nowRecord['外出事由说明'];
		needSetState['M_LC_55.visible'] = M_LC_55_isdisplay_get(retState, bundle);
	}
	needSetState['nowRecord'] = nowRecord;
	needSetState['invalidbundle'] = false;
...
function pull_M_Form_8(retState, holdSelected) {
	var hadStateParam = retState != null;
	var state = hadStateParam ? retState : store.getState();
	var bundle = {};
	setTimeout(function () {
...
function M_LC_55_isdisplay_get(state, bundle) {
	var M_Form_8_state = getStateByPath(state, 'M_Page_6.M_Form_8', {});
	var M_Form_8_nowRecord = getStateByPath(M_Form_8_state, 'M_Page_6.M_Form_8.nowRecord');
	var validErr;
	var hadValidErr = false;
	var validErrState = {};
	var callback_final = function callback_final(state, data, err) {
	...
	return M_Form_8_nowRecord['是否返回驻地'] == true;
}
function button_10_onclick() {
	var state = store.getState();
	var M_Form_8_state = getStateByPath(state, 'M_Page_6.M_Form_8', {});
	var M_Form_8_nowRecord = getStateByPath(M_Form_8_state, 'M_Page_6.M_Form_8.nowRecord');
	var M_Text_11_state = getStateByPath(M_Form_8_state, 'M_Text_11', {});
	var M_LC_58_state = getStateByPath(M_Form_8_state, 'M_LC_58', {});
	var M_Text_11_value = M_Text_11_state.value;
	var validErr;
	var hadValidErr = false;
	var validErrState = {};
	...
	validErr = BaseIsValueValid(state, M_LC_58_state, M_Text_11_state, M_Text_11_value, 'string', false, 'M_Text_11', validErrState);
	validErrState['M_Page_6.M_Form_8.M_Text_11.invalidInfo'] = validErr;
	if (validErr != null) hadValidErr = true;
	if (hadValidErr) {
		return callback_final(null, null, { info: gPreconditionInvalidInfo });
	}
	var fetchid = Math.round(Math.random() * 999999);
	var fetchKey = button_10_onclick;
	fetchTracer[fetchKey] = fetchid;
	var baseBundle = {};
	scriptBP_42_msg = PopMessageBox('', EMessageBoxType.Loading, '同意');
	var bundle_update_table_0 = Object.assign({}, baseBundle, {
		M_Form_8_nowRecord: M_Form_8_nowRecord,
		M_Text_11_value: M_Text_11_value
	});
...
function M_Dropdown_1_value_changed(state, newValue, oldValue, path, visited, delayActs, rowIndexInfo_map) {
	var needSetState = {};
	needSetState['M_Page_2.M_Form_1.M_Text_4.value'] = M_Text_4_defaultvalue_get(state);
	needSetState['M_Page_2.M_Form_1.M_LC_3.visible'] = M_LC_3_isdisplay_get(state);
	return setManyStateByPath(state, '', needSetState);
}
function M_LC_3_visible_changed(state, newValue, oldValue, path, visited, delayActs, rowIndexInfo_map) {
	var needSetState = {};
...
function M_LC_14_visible_changed(state, newValue, oldValue, path, visited, delayActs, rowIndexInfo_map) {
	var needSetState = {};
	needSetState['M_Page_0.M_Form_2.M_LC_16.visible'] = M_LC_16_isdisplay_get(state);
	return setManyStateByPath(state, '', needSetState);
}
function M_Dropdown_6_value_changed(state, newValue, oldValue, path, visited, delayActs, rowIndexInfo_map) {
	var needSetState = {};
	needSetState['M_Page_5.M_Form_7.M_Dropdown_7.value'] = M_Dropdown_7_defaultvalue_get(state);
	return setManyStateByPath(state, '', needSetState);
}
function M_CheckBox_0_value_changed(state, newValue, oldValue, path, visited, delayActs, rowIndexInfo_map) {
	var needSetState = {};
	needSetState['M_Page_5.M_Form_7.M_LC_47.visible'] = M_LC_47_isdisplay_get(state);
	return setManyStateByPath(state, '', needSetState);
}
function M_Dropdown_2_value_changed(state, newValue, oldValue, path, visited, delayActs, rowIndexInfo_map) {
	var needSetState = {};
...
function M_Dropdown_0_text_changed(state, newValue, oldValue, path, visited, delayActs, rowIndexInfo_map) {
	var needSetState = {};
	if (delayActs['call_pull_M_Form_0'] == null) {
		delayActs['call_pull_M_Form_0'] = { callfun: pull_M_Form_0 };
	};
						...
						retElem = React.createElement(
							...
							React.createElement(
								...
								React.createElement(
									...
									React.createElement(VisibleERPC_DropDown, { id: "M_Dropdown_0", parentPath: "M_Page_2.M_Form_1", pullOnce: true, pullDataSource: pull_M_Dropdown_0, textAttrName: "\u5458\u5DE5\u767B\u8BB0\u59D3\u540D", valueAttrName: "\u5458\u5DE5\u767B\u8BB0\u59D3\u540D\u4EE3\u7801", label: "\u8BF7\u5047\u4EBA\u5458" })
								),
								...
								React.createElement(
									...
									React.createElement(VisibleERPC_DropDown, { id: "M_Dropdown_1", parentPath: "M_Page_2.M_Form_1", pullOnce: true, pullDataSource: pull_M_Dropdown_1, textAttrName: "\u5458\u5DE5\u5047\u671F\u79CD\u7C7B", valueAttrName: "\u5458\u5DE5\u5047\u671F\u79CD\u7C7B\u4EE3\u7801", label: "\u5047\u671F\u79CD\u7C7B" })
								),
								React.createElement(
									VisibleERPC_LabeledControl,
								...
								React.createElement(
									VisibleERPC_Button,
									{ className: "btn btn-primary erp-control ", id: "button_4", parentPath: "M_Page_2.M_Form_1", onClick: button_4_onclick },
									"\u63D0\u4EA4\u7533\u8BF7"
								)
							),
							...
							retElem = React.createElement(
								...
								React.createElement(
									...
									React.createElement(
										...
										React.createElement(VisibleERPC_Label, { className: "erp-control ", id: "M_Label_5", parentPath: "M_Page_0.M_Form_2", type: "date" })
									),
									React.createElement(
										VisibleERPC_LabeledControl,
										{ id: "M_LC_14", parentPath: "M_Page_0.M_Form_2", label: "\u8BF7\u5047\u8D77\u59CB\u65F6\u95F4" },
										React.createElement(VisibleERPC_Label, { className: "erp-control ", id: "M_Label_6", parentPath: "M_Page_0.M_Form_2", type: "time" })
									),
									React.createElement(
										VisibleERPC_LabeledControl,
										{ id: "M_LC_15", parentPath: "M_Page_0.M_Form_2", label: "\u8BF7\u5047\u7ED3\u675F\u65E5\u671F" },
										React.createElement(VisibleERPC_Label, { className: "erp-control ", id: "M_Label_7", parentPath: "M_Page_0.M_Form_2", type: "date" })
									),
									React.createElement(
										VisibleERPC_LabeledControl,
										{ id: "M_LC_16", parentPath: "M_Page_0.M_Form_2", label: "\u8BF7\u5047\u7ED3\u675F\u65F6\u95F4" },
										React.createElement(VisibleERPC_Label, { className: "erp-control ", id: "M_Label_8", parentPath: "M_Page_0.M_Form_2", type: "time" })
									),
									React.createElement(
										VisibleERPC_LabeledControl,
									...
									React.createElement(
										...
										React.createElement(
											VisibleERPC_Button,
											{ className: "flex-grow-1 btn btn-success erp-control ", id: "button_0", parentPath: "M_Page_0.M_Form_2", onClick: button_0_onclick },
											"\u901A\u8FC7\u7533\u8BF7"
										),
										React.createElement(
											VisibleERPC_Button,
											{ className: "flex-grow-1 btn btn-danger erp-control ", id: "button_1", parentPath: "M_Page_0.M_Form_2", onClick: button_1_onclick },
											"\u62D2\u7EDD\u7533\u8BF7"
										)
									),
	...
	_createClass(CM_Form_3, [{
		...
		value: function renderContent() {
				...
				if (this.props.fetchingErr) {
					...
					if (this.props.invalidbundle) {
						...
						if (!this.props.canInsert && (this.props.records_arr == null || this.props.records_arr.length == 0)) {
							...
							retElem = React.createElement(CM_Form_3_TBody, { startRowIndex: this.props.startRowIndex, endRowIndex: this.props.endRowIndex, form: this });
							if (this.props.pagebreak) {
								navElem = React.createElement(CBaseGridFormNavBar, { pageIndex: this.props.pageIndex, rowPerPage: this.props.rowPerPage, rowPerPageChangedHandler: this.rowPerPageChangedHandler, pageCount: this.props.pageCount, prePageClickHandler: this.prePageClickHandler, nxtPageClickHandler: this.nxtPageClickHandler, pageIndexChangedHandler: this.pageIndexChangedHandler });
							}
						}
			...
			return React.createElement(
				...
				React.createElement(
					"div",
					{ id: "M_Form_3tableheader", className: "mw-100 hidenOverflow flex-shrink-0 gridFormFixHeaderDiv" },
					React.createElement(
						"table",
						...
						retElem = React.createElement(
							...
							React.createElement(
								...
								React.createElement(
									...
									React.createElement(VisibleERPC_DropDown, { id: "M_Dropdown_2", parentPath: "M_Page_1.M_Form_4", pullOnce: true, groupAttr: "\u6240\u5C5E\u7CFB\u7EDF\u540D\u79F0,\u6240\u5C5E\u90E8\u95E8\u540D\u79F0", pullDataSource: pull_M_Dropdown_2, textAttrName: "\u5458\u5DE5\u767B\u8BB0\u59D3\u540D", valueAttrName: "\u5458\u5DE5\u767B\u8BB0\u59D3\u540D\u4EE3\u7801", label: "\u5458\u5DE5\u767B\u8BB0\u59D3\u540D" })
								),
								React.createElement(
									VisibleERPC_LabeledControl,
								...
								React.createElement(
									...
									React.createElement(VisibleERPC_DropDown, { id: "M_Dropdown_3", parentPath: "M_Page_1.M_Form_4", pullOnce: true, pullDataSource: pull_M_Dropdown_3, textAttrName: "\u4EA4\u901A\u65B9\u5F0F\u79CD\u7C7B", valueAttrName: "\u4EA4\u901A\u65B9\u5F0F\u79CD\u7C7B\u4EE3\u7801", label: "\u4EA4\u901A\u65B9\u5F0F\u4EE3\u7801" })
								),
								React.createElement(
									VisibleERPC_LabeledControl,
									{ id: "M_LC_27", parentPath: "M_Page_1.M_Form_4", label: "\u4F4F\u5BBF\u62A5\u9500\u79CD\u7C7B" },
									React.createElement(VisibleERPC_DropDown, { id: "M_Dropdown_4", parentPath: "M_Page_1.M_Form_4", pullOnce: true, pullDataSource: pull_M_Dropdown_4, textAttrName: "\u4F4F\u5BBF\u62A5\u9500\u79CD\u7C7B", valueAttrName: "\u4F4F\u5BBF\u62A5\u9500\u79CD\u7C7B\u4EE3\u7801", label: "\u4F4F\u5BBF\u62A5\u9500\u79CD\u7C7B" })
								),
								React.createElement(
									VisibleERPC_LabeledControl,
									{ id: "M_LC_28", parentPath: "M_Page_1.M_Form_4", label: "\u51FA\u5DEE\u5730\u57DF\u4EE3\u7801" },
									React.createElement(VisibleERPC_DropDown, { id: "M_Dropdown_5", parentPath: "M_Page_1.M_Form_4", pullOnce: true, groupAttr: "\u4E00\u7EA7\u5730\u57DF\u540D\u79F0,\u4E8C\u7EA7\u5730\u57DF\u540D\u79F0", pullDataSource: pull_M_Dropdown_5, textAttrName: "\u6240\u5C5E\u5730\u57DF\u540D\u79F0", valueAttrName: "\u6240\u5C5E\u5730\u57DF\u540D\u79F0\u4EE3\u7801", label: "\u51FA\u5DEE\u5730\u57DF\u4EE3\u7801" })
								),
								React.createElement(
									VisibleERPC_Button,
									{ className: "btn btn-primary erp-control ", id: "button_2", parentPath: "M_Page_1.M_Form_4", onClick: button_2_onclick },
									"\u63D0\u4EA4\u7533\u8BF7"
								),
	...
	_createClass(CM_Form_5, [{
		...
		value: function renderContent() {
				...
				if (this.props.fetchingErr) {
					...
					if (this.props.invalidbundle) {
						...
						if (!this.props.canInsert && (this.props.records_arr == null || this.props.records_arr.length == 0)) {
							...
							retElem = React.createElement(CM_Form_5_TBody, { startRowIndex: this.props.startRowIndex, endRowIndex: this.props.endRowIndex, form: this });
							if (this.props.pagebreak) {
								navElem = React.createElement(CBaseGridFormNavBar, { pageIndex: this.props.pageIndex, rowPerPage: this.props.rowPerPage, rowPerPageChangedHandler: this.rowPerPageChangedHandler, pageCount: this.props.pageCount, prePageClickHandler: this.prePageClickHandler, nxtPageClickHandler: this.nxtPageClickHandler, pageIndexChangedHandler: this.pageIndexChangedHandler });
							}
						}
			...
			return React.createElement(
				...
				React.createElement(
					"div",
					{ id: "M_Form_5tableheader", className: "mw-100 hidenOverflow flex-shrink-0 gridFormFixHeaderDiv" },
					React.createElement(
						"table",
		...
		value: function renderContent() {
			...
			retElem = React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						VisibleERPC_Button,
						{ className: "btn btn-primary erp-control ", id: "button_3", parentPath: "M_Page_3", onClick: button_3_onclick },
						"\u7533\u8BF7\u8BF7\u5047"
					),
					React.createElement(
						VisibleERPC_Button,
						{ className: "btn btn-primary erp-control ", id: "button_5", parentPath: "M_Page_3", onClick: button_5_onclick },
						"\u7533\u8BF7\u51FA\u5DEE"
					),
					React.createElement(
						VisibleERPC_Button,
						{ className: "btn btn-primary erp-control ", id: "button_9", parentPath: "M_Page_3", onClick: button_9_onclick },
						"\u7533\u8BF7\u5916\u51FA"
					)
				)
			);
							...
							retElem = React.createElement(
								...
								React.createElement(
									...
									React.createElement(
										...
										React.createElement(
											VisibleERPC_Button,
											{ className: "flex-grow-1 btn btn-success erp-control ", id: "button_7", parentPath: "M_Page_4.M_Form_6", onClick: button_7_onclick },
											"\u6279\u51C6\u51FA\u5DEE"
										),
										React.createElement(
											VisibleERPC_Button,
											{ className: "flex-grow-1 btn btn-danger erp-control ", id: "button_6", parentPath: "M_Page_4.M_Form_6", onClick: button_6_onclick },
											"\u62D2\u7EDD\u51FA\u5DEE"
										)
									)
								),
						...
						retElem = React.createElement(
							...
							React.createElement(
								...
								React.createElement(
									...
									React.createElement(VisibleERPC_DropDown, { id: "M_Dropdown_6", parentPath: "M_Page_5.M_Form_7", pullOnce: true, groupAttr: "\u6240\u5C5E\u7CFB\u7EDF\u540D\u79F0,\u6240\u5C5E\u90E8\u95E8\u540D\u79F0", pullDataSource: pull_M_Dropdown_6, textAttrName: "\u5458\u5DE5\u767B\u8BB0\u59D3\u540D", valueAttrName: "\u5458\u5DE5\u767B\u8BB0\u59D3\u540D\u4EE3\u7801", label: "\u5458\u5DE5\u59D3\u540D" })
								),
								React.createElement(
									VisibleERPC_LabeledControl,
								...
								React.createElement(
									...
									React.createElement(VisibleERPC_DropDown, { id: "M_Dropdown_7", parentPath: "M_Page_5.M_Form_7", pullOnce: true, pullDataSource: pull_M_Dropdown_7, textAttrName: "\u8003\u52E4\u767B\u8BB0\u5730\u70B9", valueAttrName: "\u8003\u52E4\u767B\u8BB0\u5730\u70B9\u4EE3\u7801", label: "\u5F53\u524D\u5DE5\u4F5C\u5730\u70B9" })
								),
								React.createElement(
									VisibleERPC_LabeledControl,
								...
								React.createElement(
									...
									React.createElement(VisibleERPC_DropDown, { id: "M_Dropdown_9", parentPath: "M_Page_5.M_Form_7", pullOnce: true, pullDataSource: pull_M_Dropdown_9, textAttrName: "\u7528\u8F66\u7C7B\u578B", valueAttrName: "\u7528\u8F66\u7C7B\u578B\u4EE3\u7801", label: "\u7528\u8F66\u7C7B\u578B" })
								),
								React.createElement(
									VisibleERPC_LabeledControl,
								...
								React.createElement(
									VisibleERPC_Button,
									{ className: "btn btn-primary erp-control ", id: "button_8", parentPath: "M_Page_5.M_Form_7", onClick: button_8_onclick },
									"\u7533\u8BF7\u63D0\u4EA4"
								)
							),
							this.renderNavigater()
						...
						if (!this.props.canInsert && this.props.nowRecord == null) {
							...
							retElem = React.createElement(
								...
								React.createElement(
									...
									React.createElement(
										VisibleERPC_LabeledControl,
										{ id: "M_LC_44", parentPath: "M_Page_6.M_Form_8", label: "\u7533\u8BF7\u4EBA\u59D3\u540D" },
										React.createElement(VisibleERPC_Label, { className: "erp-control ", id: "M_Label_23", parentPath: "M_Page_6.M_Form_8", type: "string" })
									),
									React.createElement(
										VisibleERPC_LabeledControl,
										{ id: "M_LC_50", parentPath: "M_Page_6.M_Form_8", label: "\u7533\u8BF7\u5916\u51FA\u65E5\u671F" },
										React.createElement(VisibleERPC_Label, { className: "erp-control ", id: "M_Label_24", parentPath: "M_Page_6.M_Form_8", type: "date" })
									),
									React.createElement(
										VisibleERPC_LabeledControl,
										{ id: "M_LC_51", parentPath: "M_Page_6.M_Form_8", label: "\u7533\u8BF7\u5916\u51FA\u65F6\u95F4" },
										React.createElement(VisibleERPC_Label, { className: "erp-control ", id: "M_Label_25", parentPath: "M_Page_6.M_Form_8", type: "time" })
									),
									React.createElement(
										VisibleERPC_LabeledControl,
										{ id: "M_LC_52", parentPath: "M_Page_6.M_Form_8", label: "\u5F53\u524D\u5DE5\u4F5C\u5730\u70B9" },
										React.createElement(VisibleERPC_Label, { className: "erp-control ", id: "M_Label_26", parentPath: "M_Page_6.M_Form_8", type: "string" })
									),
									React.createElement(
										VisibleERPC_LabeledControl,
										{ id: "M_LC_53", parentPath: "M_Page_6.M_Form_8", label: "\u524D\u5F80\u5730\u70B9\u540D\u79F0" },
										React.createElement(VisibleERPC_Label, { className: "erp-control ", id: "M_Label_27", parentPath: "M_Page_6.M_Form_8", type: "string" })
									),
									React.createElement(
										VisibleERPC_LabeledControl,
										{ id: "M_LC_54", parentPath: "M_Page_6.M_Form_8", label: "\u662F\u5426\u8FD4\u56DE\u9A7B\u5730" },
										React.createElement(VisibleERPC_CheckBox, { id: "M_CheckBox_1", parentPath: "M_Page_6.M_Form_8", readonly: true })
									),
									React.createElement(
										VisibleERPC_LabeledControl,
										{ id: "M_LC_55", parentPath: "M_Page_6.M_Form_8", label: "\u9884\u8BA1\u8FD4\u56DE\u65F6\u95F4" },
										React.createElement(VisibleERPC_Label, { className: "erp-control ", id: "M_Label_29", parentPath: "M_Page_6.M_Form_8", type: "time" })
									),
									React.createElement(
										VisibleERPC_LabeledControl,
										{ id: "M_LC_56", parentPath: "M_Page_6.M_Form_8", label: "\u7528\u8F66\u9700\u6C42" },
										React.createElement(VisibleERPC_Label, { className: "erp-control ", id: "M_Label_30", parentPath: "M_Page_6.M_Form_8", type: "string" })
									),
									React.createElement(
										VisibleERPC_LabeledControl,
										{ id: "M_LC_57", parentPath: "M_Page_6.M_Form_8", label: "\u5916\u51FA\u4E8B\u7531\u8BF4\u660E" },
										React.createElement(VisibleERPC_Label, { className: "erp-control ", id: "M_Label_31", parentPath: "M_Page_6.M_Form_8", type: "string" })
									),
									React.createElement(
										VisibleERPC_LabeledControl,
										{ id: "M_LC_58", parentPath: "M_Page_6.M_Form_8", label: "\u5BA1\u6838\u8BF4\u660E" },
										React.createElement(VisibleERPC_Text, { id: "M_Text_11", parentPath: "M_Page_6.M_Form_8", type: "string", linetype: "1x" })
									),
									React.createElement(
										"div",
										{ className: "btn-group flex-grow-0 flex-shrink-0 d-flex erp-control " },
										React.createElement(
											VisibleERPC_Button,
											{ className: "btn-grow flex-grow-1 btn btn-success erp-control ", id: "button_10", parentPath: "M_Page_6.M_Form_8", onClick: button_10_onclick },
											"\u540C\u610F"
										),
										React.createElement(
											VisibleERPC_Button,
											{ className: "btn-grow flex-grow-1 btn btn-danger erp-control ", id: "button_11", parentPath: "M_Page_6.M_Form_8", onClick: button_11_onclick },
											"\u62D2\u7EDD"
										)
									)
								),
...
gCusValidChecker_map['M_Text_18'] = M_Text_18_validchecker;
