						...
						if (!this.props.canInsert && this.props.nowRecord == null) {
							...
							retElem = React.createElement(
								...
								React.createElement(
									...
									React.createElement(VisibleERPC_Label, { className: "text-danger bg-primary font-weight-bold erp-control ", id: "M_Label_8", parentPath: "M_Page_1.M_Form_4", type: "string" }),
