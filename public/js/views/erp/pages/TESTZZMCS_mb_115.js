...
var appStateChangedAct_map = { 'M_Page_0.M_Form_0.records_arr': fresh_M_Form_0.bind(window), 'M_Page_0.M_Form_0.recordIndex': bind_M_Form_0.bind(window), 'M_Page_0.M_Form_1.M_Text_0.value': M_Text_0_value_changed.bind(window), 'M_Page_0.M_Form_1.M_Text_1.value': M_Text_1_value_changed.bind(window) };
...
function M_Label_3_textfield_get(state, bundle) {
	...
	var M_Text_1_value = bundle != null && bundle['M_Text_1_value'] != null ? bundle['M_Text_1_value'] : getStateByPath(M_Form_1_state, 'M_Text_1.value');
	return M_Text_0_value + M_Text_1_value;
}
