...
var appStateChangedAct_map = { 'M_Page_0.M_Form_0.M_Form_2.records_arr': fresh_M_Form_2.bind(window), 'M_Page_0.M_Form_0.M_Form_2.pageIndex': bind_M_Form_2.bind(window), 'M_Page_0.M_Form_0.M_Form_1.records_arr': fresh_M_Form_1.bind(window), 'M_Page_0.M_Form_0.M_Form_1.pageIndex': bind_M_Form_1.bind(window), 'M_Page_1.M_Form_3.records_arr': fresh_M_Form_3.bind(window), 'M_Page_1.M_Form_3.recordIndex': bind_M_Form_3.bind(window), 'M_Page_1.M_Form_3.M_Form_4.records_arr': fresh_M_Form_4.bind(window), 'M_Page_1.M_Form_3.M_Form_4.recordIndex': bind_M_Form_4.bind(window), 'M_Page_1.M_Form_3.M_Form_4.M_Form_6.records_arr': fresh_M_Form_6.bind(window), 'M_Page_1.M_Form_3.M_Form_4.M_Form_6.recordIndex': bind_M_Form_6.bind(window), 'M_Page_1.M_Form_3.M_Form_5.records_arr': fresh_M_Form_5.bind(window), 'M_Page_1.M_Form_3.M_Form_5.pageIndex': bind_M_Form_5.bind(window), 'M_Page_0.M_Form_0.M_Text_1.value': M_Text_1_value_changed.bind(window) };
var pageRouter = [];
...
function fresh_M_Form_6(retState, records_arr) {
	simpleFreshFormFun(retState, records_arr, 'M_Page_1.M_Form_3.M_Form_4.M_Form_6', bind_M_Form_6);
}
function bind_M_Form_6(retState, newIndex, oldIndex) {
	var formState = getStateByPath(retState, 'M_Page_1.M_Form_3.M_Form_4.M_Form_6', {});
	var records_arr = formState.records_arr;
	var needSetState = {};
	var bundle = {};
	var nowRecord = null;
	...
	needSetState['nowRecord'] = nowRecord;
	needSetState['invalidbundle'] = false;
	retState = setManyStateByPath(retState, 'M_Page_1.M_Form_3.M_Form_4.M_Form_6', needSetState);
	return retState;
}
function pull_M_Form_6(retState) {
	...
	if (IsEmptyString(M_Form_4_nowRecord)) {
		if (hadStateParam) {
			return setStateByPath(state, 'M_Page_1.M_Form_3.M_Form_4.M_Form_6.invalidbundle', gPreconditionInvalidInfo);
		} else {
			store.dispatch(makeAction_setStateByPath(gPreconditionInvalidInfo, 'M_Page_1.M_Form_3.M_Form_4.M_Form_6.invalidbundle'));
		}
	}
	if (hadValidErr) {
		if (hadStateParam) {
	...
	setTimeout(function () {
		store.dispatch(fetchJsonPost(appServerUrl, { bundle: bundle, action: 'pulldata_M_Form_6' }, makeFTD_Prop('M_Page_1.M_Form_3.M_Form_4', 'M_Form_6', 'records_arr', false), EFetchKey.FetchPropValue));
	}, 50);
	return state;
}
						...
						if (!this.props.canInsert && this.props.nowRecord == null) {
							...
							retElem = React.createElement(
								...
								React.createElement(
									...
									React.createElement(VisibleCM_Form_6, { id: "M_Form_6", parentPath: "M_Page_1.M_Form_3.M_Form_4" })
								),
								this.renderNavigater()
							);
						}
						...
						if (!this.props.canInsert && this.props.nowRecord == null) {
							...
							retElem = React.createElement(
								...
								React.createElement(
									"div",
									{ className: "d-flex flex-grow-1  flex-column" },
									React.createElement(VisibleERPC_Label, { className: "erp-control ", id: "M_Label_30", parentPath: "M_Page_1.M_Form_3.M_Form_4.M_Form_6", type: "string" })
								),
								this.renderNavigater()
							);
						}
...
function CM_Form_6_mapstatetoprops(state, ownprops) {
	var retProps = {};
	var ctlState = getStateByPath(state, 'M_Page_1.M_Form_3.M_Form_4.M_Form_6', {});
	retProps.fetching = ctlState.fetching;
	retProps.fetchingErr = ctlState.fetchingErr;
	retProps.records_arr = ctlState.records_arr;
	retProps.recordIndex = ctlState.recordIndex;
