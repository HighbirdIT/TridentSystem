...
function bind_M_Form_4(retState, newIndex, oldIndex) {
	...
	if (records_arr == null || newIndex == -1 || records_arr.length == 0) {} else {
		...
		needSetState['M_Label_30.text'] = nowRecord['所属部门名称'];
		needSetState['M_Text_0.value'] = nowRecord['员工登记姓名'];
						...
						if (!this.props.canInsert && this.props.nowRecord == null) {
							...
							retElem = React.createElement(
								...
								React.createElement(
									"div",
									{ className: "d-flex flex-grow-1  flex-column" },
									React.createElement(VisibleERPC_Label, { className: "erp-control ", id: "M_Label_30", parentPath: "M_Page_1.M_Form_3.M_Form_4", type: "string" }),
									React.createElement(VisibleERPC_Text, { id: "M_Text_0", parentPath: "M_Page_1.M_Form_3.M_Form_4", type: "string", linetype: "single" }),
									React.createElement(
										VisibleERPC_LabeledControl,
