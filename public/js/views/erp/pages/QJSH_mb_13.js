...
function pull_M_Form_0(retState) {
	...
	var bundle = {};
	bundle.sqlBP_7_员工登记姓名代码 = M_Form_1_nowRecord.员工登记姓名代码;
	bundle.sqlBP_7_员工登记姓名 = M_Form_1_nowRecord.员工登记姓名;
	setTimeout(function () {
...
var CM_Page_2 = function (_React$PureComponent2) {
	...
	_createClass(CM_Page_2, [{
		...
		value: function renderContent() {
			...
			retElem = React.createElement(
				"div",
				{ className: "d-flex flex-grow-1 flex-shrink-0 flex-column ", style: { height: 'calc(100% - 40px)', overflow: 'hidden' } },
