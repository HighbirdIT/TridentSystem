...
var appStateChangedAct_map = { 'M_Page_0.M_Form_0.records_arr': fresh_M_Form_0.bind(window), 'M_Page_0.M_Form_0.recordIndex': bind_M_Form_0.bind(window), 'M_Page_0.M_Form_0.M_Text_8.value': M_Text_8_value_changed.bind(window) };
...
function bind_M_Form_0(retState, newIndex, oldIndex) {
	...
	if (records_arr == null || newIndex == -1 || records_arr.length == 0) {} else {
		...
		needSetState['M_Text_13.value'] = nowRecord['是否返回驻地'];
...
function M_Text_4_textfield_get(state, bundle) {
	...
	var M_Text_8_value = bundle != null && bundle['M_Text_8_value'] != null ? bundle['M_Text_8_value'] : M_Text_8_state.value;
	var validErr;
	...
	validErr = BaseIsValueValid(state, M_LC_4_state, M_Text_8_state, M_Text_8_value, 'string', false, 'M_Text_8', validErrState);
	...
	return getFormatTimeString(M_Text_8_value, false);
}
function M_Text_8_value_changed(state, newValue, oldValue, path, visited, delayActs) {
	var needSetState = {};
	needSetState['M_Page_0.M_Form_0.M_Text_4.value'] = M_Text_4_textfield_get(state);
					...
					retElem = React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								...
								React.createElement(VisibleERPC_Text, { id: 'M_Text_15', parentPath: 'M_Page_0.M_Form_0', type: 'string', linetype: 'single' })
							),
							React.createElement(
								VisibleERPC_LabeledControl,
							...
							React.createElement(
								...
								React.createElement(VisibleERPC_Text, { id: 'M_Text_13', parentPath: 'M_Page_0.M_Form_0', type: 'string', linetype: 'single' })
							),
							React.createElement(
								VisibleERPC_LabeledControl,
								{ id: 'M_LC_11', parentPath: 'M_Page_0.M_Form_0', label: '\u8FD4\u56DE\u65F6\u95F4' },
								React.createElement(VisibleERPC_Text, { id: 'M_Text_14', parentPath: 'M_Page_0.M_Form_0', type: 'string', linetype: 'single' })
							),
							React.createElement(
								VisibleERPC_LabeledControl,
								{ id: 'M_LC_13', parentPath: 'M_Page_0.M_Form_0', label: '\u5916\u51FA\u4E8B\u7531' },
								React.createElement(VisibleERPC_Text, { id: 'M_Text_16', parentPath: 'M_Page_0.M_Form_0', type: 'string', linetype: '1x' })
							),
							React.createElement(
								'button',
