...
var appStateChangedAct_map = { 'M_Page_2.M_Dropdown_0.value': M_Dropdown_0_value_changed.bind(window), 'M_Page_2.M_Dropdown_0.text': M_Dropdown_0_text_changed.bind(window), 'M_Page_2.M_Dropdown_1.value': M_Dropdown_1_value_changed.bind(window), 'M_Page_2.M_LC_3.visible': M_LC_3_visible_changed.bind(window), 'M_Page_2.M_Text_2.visible': M_Text_2_visible_changed.bind(window) };
...
function active_M_Page_2(state) {
	...
	needSetState['M_Page_2.M_Text_5.visible'] = M_Text_5_isdisplay_get(state);
	needSetState['M_Page_2.M_Text_5.value'] = '17:30';
...
function M_Text_5_isdisplay_get(state, bundle) {
	var M_Text_2_visible = bundle != null && bundle['M_Text_2_visible'] != null ? bundle['M_Text_2_visible'] : getStateByPath(state, 'M_Page_2.M_Text_2.visible');
	var callback_final = function callback_final(state, data, err) {
		var needSetState = {};
		needSetState.visible = err == null ? data : null;
		return setManyStateByPath(state, 'M_Page_2.M_Text_5', needSetState);
	};
	if (IsEmptyString(M_Text_2_visible)) {
		return callback_final(state, null, { info: '条件不足' });
	}
	return M_Text_2_visible;
	return null;
}
...
function M_Text_2_visible_changed(state, newValue, oldValue, path, visited, delayActs) {
	var needSetState = {};
	needSetState['M_Page_2.M_Text_5.visible'] = M_Text_5_isdisplay_get(state);
	return setManyStateByPath(state, '', needSetState);
}
