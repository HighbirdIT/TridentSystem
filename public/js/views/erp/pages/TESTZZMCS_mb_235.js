		...
		value: function renderContent() {
			...
			retElem = React.createElement(
				...
				React.createElement(
					...
					React.createElement(VisibleERPC_Text, { id: 'M_Text_2', parentPath: 'M_Page_2.M_Form_1', type: 'time', nullable: true })
				),
				...
				React.createElement(
					...
					React.createElement(VisibleERPC_Text, { id: 'M_Text_5', parentPath: 'M_Page_2.M_Form_1', type: 'time', nullable: true })
				),
				React.createElement(
					VisibleERPC_LabeledControl,
