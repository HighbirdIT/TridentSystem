...
function button_5_onclick() {
	...
	if (M_Form_2_nowRecord['最终确认说明'] == '无') {
		var ret = callback_final(state, null, '请给出认定理由。');
		return ret == null ? state : ret;
	} else {
		var bundle_update_table_0 = {
			RCDKEY: M_Form_2_nowRecord['滴滴乘车记录代码'],
...
function button_6_onclick() {
	...
	if (M_Form_2_nowRecord['最终确认说明'] == '无') {
		var ret = callback_final(state, null, '请给出认定的理由。');
		return ret == null ? state : ret;
	} else {
		var bundle_update_table_0 = {
			RCDKEY: M_Form_2_nowRecord['滴滴乘车记录代码'],
							...
							retElem = React.createElement(
								...
								React.createElement(
									...
									React.createElement(
										...
										React.createElement(VisibleERPC_Text, { id: "M_Text_6", parentPath: "M_Page_1.M_Form_2", type: "string", linetype: "single" })
									),
									React.createElement(
										VisibleERPC_LabeledControl,
										{ id: "M_LC_40", parentPath: "M_Page_1.M_Form_2", label: "\u5BA1\u6838\u786E\u8BA4\u8BF4\u660E" },
										React.createElement(VisibleERPC_Text, { id: "M_Text_5", parentPath: "M_Page_1.M_Form_2", type: "string", linetype: "1x" })
									),
									React.createElement(
										VisibleERPC_LabeledControl,
									...
									React.createElement(
										...
										React.createElement(VisibleERPC_Text, { id: "M_Text_7", parentPath: "M_Page_1.M_Form_2", type: "string", linetype: "single" })
									),
									React.createElement(
										VisibleERPC_LabeledControl,
										{ id: "M_LC_43", parentPath: "M_Page_1.M_Form_2", label: "\u5BA1\u6838\u786E\u8BA4\u8BF4\u660E" },
										React.createElement(VisibleERPC_Text, { id: "M_Text_8", parentPath: "M_Page_1.M_Form_2", type: "string", linetype: "1x" })
									),
									React.createElement(
										VisibleERPC_LabeledControl,
										{ id: "M_LC_44", parentPath: "M_Page_1.M_Form_2", label: "\u7533\u8FA9\u786E\u8BA4\u8BF4\u660E" },
										React.createElement(VisibleERPC_Text, { id: "M_Text_9", parentPath: "M_Page_1.M_Form_2", type: "string", linetype: "1x" })
									),
									React.createElement(
										VisibleERPC_LabeledControl,
