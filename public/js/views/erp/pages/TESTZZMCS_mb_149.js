...
var appStateChangedAct_map = { 'M_Page_2.M_Form_1.records_arr': fresh_M_Form_1.bind(window), 'M_Page_2.M_Form_1.recordIndex': bind_M_Form_1.bind(window), 'M_Page_2.M_Text_2.textfield': M_Text_2_textfield_changed.bind(window) };
...
function fresh_M_Form_1(retState, records_arr) {
	simpleFreshFormFun(retState, records_arr, 'M_Page_2.M_Form_1');
}
...
function pull_M_Form_1(retState) {
	store.dispatch(fetchJsonPost(appServerUrl, { action: 'pulldata_M_Form_1' }, makeFTD_Prop('M_Page_2', 'M_Form_1', 'records_arr', false), EFetchKey.FetchPropValue));
	return retState;
}
function M_Text_2_textfield_changed(state, newValue, oldValue, path, visited, delayActs) {
	var needSetState = {};
