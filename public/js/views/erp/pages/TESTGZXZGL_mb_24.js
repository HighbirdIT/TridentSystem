...
function pull_M_Dropdown_0(parentPath) {
	...
	var ftdProp = makeFTD_Prop(parentPath, 'M_Dropdown_0', 'options_arr', false);
	store.dispatch(fetchJsonPost(appServerUrl, { bundle: bundle, action: 'pulldata_M_Dropdown_0' }, ftdProp, EFetchKey.FetchPropValue));
}
			...
			for (var rowIndex = startRowIndex; rowIndex <= endRowIndex; ++rowIndex) {
				trElems_arr.push(React.createElement(
					...
					React.createElement(
						...
						React.createElement(VisibleERPC_DropDown, { rowIndex: rowIndex, id: "M_Dropdown_0", parentPath: "M_Page_0.M_Form_0", groupAttr: "\u5458\u5DE5\u5728\u804C\u72B6\u6001,\u6240\u5C5E\u7CFB\u7EDF\u540D\u79F0,\u6240\u5C5E\u90E8\u95E8\u540D\u79F0", pullDataSource: pull_M_Dropdown_0, textAttrName: "\u5458\u5DE5\u767B\u8BB0\u59D3\u540D", valueAttrName: "\u5458\u5DE5\u767B\u8BB0\u59D3\u540D\u4EE3\u7801", label: "\u767B\u8BB0\u4EBA\u5458" })
					),
					React.createElement(
						"td",
						null,
