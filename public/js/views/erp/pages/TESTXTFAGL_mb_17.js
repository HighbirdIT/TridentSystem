...
function bind_M_Form_0(retState, newIndex, oldIndex) {
	...
	if (records_arr == null || newIndex == -1 || records_arr.length == 0) {} else {
		...
		needSetState['M_Text_0.value'] = nowRecord['系统方案名称'];
		needSetState['M_Dropdown_0.text'] = nowRecord['系统流程名称代码'];
		needSetState['M_Dropdown_0.text'] = nowRecord['系统流程名称代码'];
		needSetState['M_Text_1.value'] = nowRecord['是否列表可见'];
		needSetState['M_Dropdown_1.text'] = nowRecord['移动端LN'];
		needSetState['M_Dropdown_2.text'] = nowRecord['桌面端LN'];
	}
			...
			if (this.props.fetching) {
				...
				if (!this.props.canInsert && this.props.nowRecord == null) {
					...
					retElem = React.createElement(
						...
						React.createElement(
							VisibleERPC_LabeledControl,
							{ id: 'M_LC_1', parentPath: 'M_Page_0.M_Form_0', label: '\u7CFB\u7EDF\u6D41\u7A0B\u540D\u79F0\u4EE3\u7801' },
							React.createElement(VisibleERPC_DropDown, { id: 'M_Dropdown_0', parentPath: 'M_Page_0.M_Form_0', pullDataSource: pull_M_Dropdown_0, textAttrName: '\u7CFB\u7EDF\u6D41\u7A0B\u540D\u79F0', valueAttrName: '\u7CFB\u7EDF\u6D41\u7A0B\u540D\u79F0\u4EE3\u7801', label: '\u7CFB\u7EDF\u6D41\u7A0B\u540D\u79F0\u4EE3\u7801' })
						),
						React.createElement(
							VisibleERPC_LabeledControl,
						...
						React.createElement(
							'button',
							{ className: 'btn btn-primary erp-control ', id: 'button_0' },
							'\u767B\u8BB0\u786E\u8BA4'
						),
