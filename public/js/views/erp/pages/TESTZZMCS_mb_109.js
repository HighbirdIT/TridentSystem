...
var appStateChangedAct_map = { 'M_Page_0.M_Form_0.records_arr': fresh_M_Form_0.bind(window), 'M_Page_0.M_Form_0.recordIndex': bind_M_Form_0.bind(window), 'M_Page_0.M_Form_0.M_LC_3.label': M_LC_3_label_changed.bind(window), 'M_Page_0.M_Form_1.M_Text_0.value': M_Text_0_value_changed.bind(window) };
		...
		value: function renderContent() {
			...
			retElem = React.createElement(
				...
				React.createElement(
					...
					React.createElement(VisibleERPC_Label, { className: 'erp-control ', id: 'M_Label_3', parentPath: 'M_Page_0.M_Form_1', text: '[object Object]' })
				),
				this.renderNavigater()
			);
			return retElem;
