				...
				if (!this.props.canInsert && this.props.nowRecord == null) {
					...
					retElem = React.createElement(
						...
						React.createElement(
							...
							React.createElement(VisibleERPC_Label, { className: "erp-control ", id: "M_Label_10", parentPath: "M_Page_2.M_Form_1", type: "string", text: "\u5F53\u524D\u72B6\u6001" })
						),
						React.createElement(
							VisibleERPC_LabeledControl,
						...
						React.createElement(
							...
							React.createElement(VisibleERPC_Label, { className: "erp-control ", id: "M_Label_8", parentPath: "M_Page_2.M_Form_1", type: "time", text: "\u8D77\u59CB\u65F6\u95F4" })
						),
						React.createElement(
							VisibleERPC_LabeledControl,
						...
						React.createElement(
							...
							React.createElement(VisibleERPC_Label, { className: "erp-control ", id: "M_Label_9", parentPath: "M_Page_2.M_Form_1", type: "time", text: "\u7ED3\u675F\u65F6\u95F4" })
						),
						React.createElement(
							VisibleERPC_LabeledControl,
