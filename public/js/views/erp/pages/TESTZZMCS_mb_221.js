...
var M_Text_7_style = { "height": "500px" };
	...
	_createClass(CM_Page_2, [{
		...
		value: function renderContent() {
			...
			retElem = React.createElement(
				...
				React.createElement(VisibleERPC_Text, { style: M_Text_7_style, id: "M_Text_7", parentPath: "M_Page_2", type: "string", linetype: "1x" }),
				React.createElement(
					VisibleERPC_LabeledControl,
				...
				React.createElement(
					"button",
					{ className: "btn btn-primary erp-control ", id: "button_4" },
					"\u63D0\u4EA4\u7533\u8BF7"
				)
			);
			return retElem;
