...
var appStateChangedAct_map = { 'M_Page_2.M_Form_1.records_arr': fresh_M_Form_1.bind(window), 'M_Page_2.M_Form_1.recordIndex': bind_M_Form_1.bind(window), 'M_Page_2.M_Dropdown_0.value': M_Dropdown_0_value_changed.bind(window), 'M_Page_2.M_Dropdown_1.value': M_Dropdown_1_value_changed.bind(window) };
...
function pull_M_Dropdown_1() {
	var bundle = {};
	var useState = store.getState();
	bundle.M_Dropdown_0_value = getStateByPath(useState, 'M_Page_2.M_Dropdown_0.value');
...
function bind_M_Form_1(retState, newIndex, oldIndex) {
	...
	if (records_arr == null || newIndex == -1 || records_arr.length == 0) {} else {
		...
		needSetState['M_Label_0.text'] = nowRecord['员工登记姓名'];
	}
...
function pull_M_Form_1(retState) {
	...
	bundle.M_Dropdown_0_value = getStateByPath(useState, 'M_Page_2.M_Dropdown_0.value');
	bundle.M_Dropdown_1_value = getStateByPath(useState, 'M_Page_2.M_Dropdown_1.value');
	if (IsEmptyString(bundle.M_Dropdown_0_value) || IsEmptyString(bundle.M_Dropdown_1_value)) {
		store.dispatch(makeAction_setStateByPath(true, 'M_Page_2.M_Form_1.invalidbundle'));
		return;
	}
...
function M_Dropdown_0_value_changed(state, newValue, oldValue, path, visited, delayActs) {
	var needSetState = {};
	needSetState['M_Page_2.M_Dropdown_1.text'] = null;
	needSetState['M_Page_2.M_Dropdown_1.value'] = null;
		...
		value: function renderContent() {
			...
			retElem = React.createElement(
				...
				React.createElement(
					...
					{ id: "M_LC_0", parentPath: "M_Page_2", label: "\u6240\u5C5E\u7CFB\u7EDF" },
					React.createElement(VisibleERPC_DropDown, { id: "M_Dropdown_0", parentPath: "M_Page_2", pullDataSource: pull_M_Dropdown_0, textAttrName: "\u6240\u5C5E\u7CFB\u7EDF\u540D\u79F0", valueAttrName: "\u6240\u5C5E\u7CFB\u7EDF\u540D\u79F0\u4EE3\u7801", label: "\u6240\u5C5E\u7CFB\u7EDF" })
				),
				React.createElement(
					VisibleERPC_LabeledControl,
					{ id: "M_LC_1", parentPath: "M_Page_2", label: "\u6240\u5C5E\u90E8\u95E8" },
					React.createElement(VisibleERPC_DropDown, { id: "M_Dropdown_1", parentPath: "M_Page_2", pullDataSource: pull_M_Dropdown_1, textAttrName: "\u6240\u5C5E\u90E8\u95E8\u540D\u79F0", valueAttrName: "\u6240\u5C5E\u90E8\u95E8\u540D\u79F0\u4EE3\u7801", label: "\u6240\u5C5E\u90E8\u95E8" })
				),
