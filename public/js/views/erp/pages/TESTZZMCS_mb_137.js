		...
		value: function renderContent() {
			...
			retElem = React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						"button",
						{ className: "flex-grow-1 btn btn-light erp-control ", id: "button_0", onClick: button_0_onclik },
						"\u524D\u4E00\u5929"
					),
					React.createElement(VisibleERPC_Text, { style: M_Text_0_style, id: "M_Text_0", parentPath: "M_Page_0", type: "date" }),
					React.createElement(
						"button",
						{ className: "flex-grow-1 btn btn-light erp-control ", id: "button_1", onClick: button_1_onclik },
						"\u540E\u4E00\u5929"
					)
				),
