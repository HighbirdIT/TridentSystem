...
function M_Text_1_validchecker(nowValue, comeState, comeValidErrState) {
	...
	if (getDateDiff('天', nowValue, getNowDate()) < -10) {
		return '只能补登十天之内的出差申请';
	}
}
...
function M_Text_0_validchecker(nowValue, comeState, comeValidErrState) {
	...
	if (validErrState.hasOwnProperty('M_Page_0.M_Form_0.M_Text_1.invalidInfo')) {
		validErr = validErrState['M_Page_0.M_Form_0.M_Text_1.invalidInfo'];
	} else {
		validErr = BaseIsValueValid(comeState, M_LC_1_state, M_Text_1_state, M_Text_1_value, 'date', false, 'M_Text_1', validErrState);
...
function button_0_onclick() {
	...
	var bundle_querysql_0 = {
		起始日期: M_Text_1_value,
		结束日期: M_Text_0_value,
		员工姓名代码: M_Dropdown_0_value
	};
	setTimeout(function () {
		if (fetchTracer['button_0_onclick'] != fetchid) return;
		store.dispatch(fetchJsonPost(appServerUrl, { bundle: bundle_querysql_0, action: '_query_已有出差查询' }, makeFTD_Callback(function (state, data_querysql_0, error_querysql_0) {
			if (error_querysql_0) {
				return callback_final(state, null, error_querysql_0);
			}
			if (data_querysql_0.length > 0) {
				var ret = callback_final(state, null, { info: '所选日期已有出差记录' });
						...
						retElem = React.createElement(
							...
							React.createElement(
								...
								React.createElement(
									...
									React.createElement(VisibleERPC_DropDown, { id: 'M_Dropdown_0', parentPath: 'M_Page_0.M_Form_0', groupAttr: '\u6240\u5C5E\u7CFB\u7EDF\u540D\u79F0,\u6240\u5C5E\u90E8\u95E8\u540D\u79F0', pullDataSource: pull_M_Dropdown_0, textAttrName: '\u5458\u5DE5\u767B\u8BB0\u59D3\u540D', valueAttrName: '\u5458\u5DE5\u767B\u8BB0\u59D3\u540D\u4EE3\u7801', label: '\u51FA\u5DEE\u4EBA\u5458' })
								),
								React.createElement(
									VisibleERPC_LabeledControl,
								...
								React.createElement(
									...
									React.createElement(VisibleERPC_DropDown, { id: 'M_Dropdown_3', parentPath: 'M_Page_0.M_Form_0', groupAttr: '\u4E00\u7EA7\u5730\u57DF\u540D\u79F0,\u4E8C\u7EA7\u5730\u57DF\u540D\u79F0', pullDataSource: pull_M_Dropdown_3, textAttrName: '\u6240\u5C5E\u5730\u57DF\u540D\u79F0', valueAttrName: '\u6240\u5C5E\u5730\u57DF\u540D\u79F0\u4EE3\u7801', label: '\u51FA\u5DEE\u5730\u57DF' })
								),
								React.createElement(
									VisibleERPC_LabeledControl,
