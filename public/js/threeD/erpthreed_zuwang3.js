...
var C组网步骤_铺设索 = function (_C3) {
    ...
    _createClass(C组网步骤_铺设索, [{
        ...
        value: function setIndex(newIndex) {
            ...
            目标网片.索夹_arr.forEach(function (索夹) {
                if (索夹.关联竖索 == null) {
                    索夹.meshObj.visible = 索夹.关联次索.object3d.visible || 索夹.关联主索.object3d.visible;
                }
            });
            // B端类型	T端类型
            // SD02	SD02反牙
    ...
    _createClass(CM_Page_ZWParamShoter, [{
        ...
        value: function renderContent() {
            ...
            retElem = React.createElement(
                'div',
                { className: 'd-flex flex-grow-1 flex-shrink-1 flex-column fixPageContent ' },
                React.createElement(VisibleERPC_IFrame, { className: 'flex-grow-1 flex-shrink-1 d-flex flex-column ', proj: 'ZWGJY', flowCode: this.props.flowCode, pageType: 'mb', onMessageFun: iframe_shot_onReceiveMsg, id: 'iframe_shot', parentPath: this.props.parentPath }),
                this.renderSidePage()
            );
            return retElem;
        }
